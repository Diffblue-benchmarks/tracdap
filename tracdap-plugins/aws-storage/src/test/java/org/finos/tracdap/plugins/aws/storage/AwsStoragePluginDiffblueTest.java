...
class AwsStoragePluginDiffblueTest {
   ...
   *
   * <p>Method under test: {@link AwsStoragePlugin#pluginName()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link AwsStoragePlugin#serviceInfo()}
   */
  @Test
  ...
  /**
   * Test {@link AwsStoragePlugin#createService(String, Properties, ConfigManager)} with {@code
   * service}, {@code properties}, {@code configManager}.
   *
   * <p>Method under test: {@link AwsStoragePlugin#createService(String, Properties, ConfigManager)}
   */
  @Test
  @DisplayName(
  ...
  void testCreateServiceWithServicePropertiesConfigManager() {
    ...
    ConfigManager configManager = new ConfigManager("1.99*", workingDir, new PluginManager());

    // Act
    Object actualCreateServiceResult =
        awsStoragePlugin.createService("S3_OBJECT_STORAGE", properties, configManager);

    // Assert
    CompletionStage<Boolean> existsResult =
        ((S3ObjectStorage) actualCreateServiceResult).exists("Storage Path", null);
  ...
  void testCreateServiceWithServicePropertiesConfigManager_thenThrowEPluginNotAvailable() {
    ...
    assertThrows(
        ...
        () -> awsStoragePlugin.createService("Service", properties, configManager));
  }

  /**
   * Test new {@link AwsStoragePlugin} (default constructor).
   *
   * <p>Method under test: default or parameterless constructor of {@link AwsStoragePlugin}
   */
  @Test
