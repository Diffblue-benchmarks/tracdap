...
class AzureStoragePluginDiffblueTest {
   ...
   *
   * <p>Method under test: {@link AzureStoragePlugin#pluginName()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link AzureStoragePlugin#serviceInfo()}
   */
  @Test
  ...
  /**
   * Test {@link AzureStoragePlugin#createService(String, Properties, ConfigManager)} with {@code
   * service}, {@code properties}, {@code configManager}.
   *
   * <p>Method under test: {@link AzureStoragePlugin#createService(String, Properties,
   * ConfigManager)}
   */
  @Test
  @DisplayName(
  ...
  void testCreateServiceWithServicePropertiesConfigManager() {
    ...
    Object actualCreateServiceResult =
        azureStoragePlugin.createService("AZURE_BLOB_STORAGE", properties, configManager);

    // Assert
    CompletionStage<Boolean> existsResult =
        ((AzureBlobStorage) actualCreateServiceResult).exists("Storage Path", null);
  ...
  void testCreateServiceWithServicePropertiesConfigManager_thenThrowEPluginNotAvailable() {
    ...
    assertThrows(
        ...
        () -> azureStoragePlugin.createService("Service", properties, configManager));
  }

  /**
   * Test new {@link AzureStoragePlugin} (default constructor).
   *
   * <p>Method under test: default or parameterless constructor of {@link AzureStoragePlugin}
   */
  @Test
