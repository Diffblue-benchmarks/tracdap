...
class SshExecutorStateDiffblueTest {
   ...
   *
   * <p>Method under test: {@link SshExecutorState#SshExecutorState(String, int, String, String)}
   */
  @Test
  ...
  void testNewSshExecutorState() {
    // Arrange and Act
    SshExecutorState actualSshExecutorState =
        new SshExecutorState("0123456789ABCDEF", 8080, "0123456789ABCDEF", "0123456789ABCDEF");
   ...
   *
   * <p>Method under test: {@link SshExecutorState#withVolume(String)}
   */
  @Test
  ...
  void testWithVolume() {
    // Arrange
    SshExecutorState sshExecutorState =
        new SshExecutorState("0123456789ABCDEF", 8080, "0123456789ABCDEF", "0123456789ABCDEF");

    // Act
    SshExecutorState actualWithVolumeResult = sshExecutorState.withVolume("0123456789ABCDEF");
   ...
   *
   * <p>Method under test: {@link SshExecutorState#withPid(long)}
   */
  @Test
  ...
  void testWithPid() {
    ...
    // Act
    SshExecutorState actualWithPidResult = sshExecutorState.withPid(1L);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "String SshExecutorState.getBatchDir()",
    "String SshExecutorState.getBatchUser()",
    "long SshExecutorState.getPid()",
    "String SshExecutorState.getRemoteHost()",
    "int SshExecutorState.getRemotePort()",
    "List SshExecutorState.getVolumes()"
  })
