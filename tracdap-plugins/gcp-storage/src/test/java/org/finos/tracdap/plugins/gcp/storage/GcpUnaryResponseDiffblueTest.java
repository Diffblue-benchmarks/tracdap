...
class GcpUnaryResponseDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void GcpUnaryResponse.<init>()",
    "CompletionStage GcpUnaryResponse.getResult()"
  })
   ...
   *   <li>Then {@link GcpUnaryResponse} (default constructor) Result {@link CompletableFuture}.
   * </ul>
   *
   * <p>Method under test: {@link GcpUnaryResponse#onError(Throwable)}
   */
  @Test
  @DisplayName(
      "Test onError(Throwable); when Throwable(); then GcpUnaryResponse (default constructor) Result CompletableFuture")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link GcpUnaryResponse#onCompleted()}
   */
  @Test
