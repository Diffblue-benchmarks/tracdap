...
class GcsObjectStorageDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link GcsObjectStorage#GcsObjectStorage(String, Properties)}
   */
  @Test
  @DisplayName("Test new GcsObjectStorage(String, Properties); then exists 'Storage Path' and 'null' return CompletableFuture")
  ...
  void testNewGcsObjectStorage_thenExistsStoragePathAndNullReturnCompletableFuture() {
    ...
    CompletionStage<Boolean> existsResult = (new GcsObjectStorage("Storage Key", new Properties()))
   ...
   * </ul>
   * <p>
   * Method under test: {@link GcsObjectStorage#fsExistsCallback(String, Throwable)}
   */
  @Test
  ...
  void testFsExistsCallback_thenReturnTrue() {
    // Arrange, Act and Assert
    assertTrue((new GcsObjectStorage("Storage Key", new Properties())).fsExistsCallback("Storage Path", null));
  }
}
