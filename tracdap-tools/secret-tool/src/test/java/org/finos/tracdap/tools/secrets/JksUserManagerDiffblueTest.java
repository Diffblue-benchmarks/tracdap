...
class JksUserManagerDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link JksUserManager#JksUserManager(ConfigManager)}
   */
  @Test
  ...
  void testNewJksUserManager_thenThrowETracPublic() {
    ...
    when(plugins.createConfigService(
        ...
        .thenThrow(new ETracPublic("Not all who wander are lost"));
    ...
    // Act and Assert
    assertThrows(ETracPublic.class, () -> new JksUserManager(configManager));
