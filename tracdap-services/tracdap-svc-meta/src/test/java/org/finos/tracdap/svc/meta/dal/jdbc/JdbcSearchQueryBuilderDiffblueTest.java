...
class JdbcSearchQueryBuilderDiffblueTest {
   ...
   *   <li>Then return Query is a string.
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildSearchQuery(short, SearchParameters)}
   */
  @Test
  @DisplayName(
      "Test buildSearchQuery(short, SearchParameters); when DefaultInstance; then return Query is a string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildSearchQuery(short, SearchParameters)"
  })
  void testBuildSearchQuery_whenDefaultInstance_thenReturnQueryIsAString() {
    // Arrange and Act
    JdbcSearchQuery actualBuildSearchQueryResult =
        new JdbcSearchQueryBuilder()
            .buildSearchQuery((short) 1, SearchParameters.getDefaultInstance());
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildPriorSearchQuery(short,
   * SearchParameters)}
   */
  @Test
  @DisplayName(
      "Test buildPriorSearchQuery(short, SearchParameters); when DefaultInstance; then return Query is a string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildPriorSearchQuery(short, SearchParameters)"
  })
  void testBuildPriorSearchQuery_whenDefaultInstance_thenReturnQueryIsAString() {
    // Arrange and Act
    JdbcSearchQuery actualBuildPriorSearchQueryResult =
        new JdbcSearchQueryBuilder()
            .buildPriorSearchQuery((short) 1, SearchParameters.getDefaultInstance());

    // Assert
    assertEquals(
        "select max(t0.tag_pk) as tag_pk\n"
            + "from tag t0\n"
            + "join object_definition od0\n"
            + "  on od0.tenant_id = t0.tenant_id\n"
            + "  and od0.definition_pk = t0.definition_fk\n"
            ...
            + "order by max(t0.tag_timestamp) desc",
        actualBuildPriorSearchQueryResult.getQuery());
  ...
  /**
   * Test {@link JdbcSearchQueryBuilder#buildCommonSearchQuery(short, SearchParameters, String,
   * String)}.
   *
   * <ul>
   *   <li>When DefaultInstance.
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildCommonSearchQuery(short,
   * SearchParameters, String, String)}
   */
  @Test
  @DisplayName(
      "Test buildCommonSearchQuery(short, SearchParameters, String, String); when DefaultInstance; then return Query is a string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testBuildCommonSearchQuery_whenDefaultInstance_thenReturnQueryIsAString() {
    // Arrange and Act
    JdbcSearchQuery actualBuildCommonSearchQueryResult =
        new JdbcSearchQueryBuilder()
            .buildCommonSearchQuery(
                (short) 1,
    ...
    assertEquals(
        "select Select Fields\n"
            ...
            + "order by max(t0.tag_timestamp) desc",
        actualBuildCommonSearchQueryResult.getQuery());
  ...
  /**
   * Test {@link JdbcSearchQueryBuilder#buildSearchQueryFromTemplate(String, int, JdbcSearchQuery,
   * Stream)}.
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildSearchQueryFromTemplate(String, int,
   * JdbcSearchQuery, Stream)}
   */
  @Test
  ...
  void testBuildSearchQueryFromTemplate() {
    ...
    // Act
    JdbcSearchQuery actualBuildSearchQueryFromTemplateResult =
        jdbcSearchQueryBuilder.buildSearchQueryFromTemplate(
            "Query Template", 10, queryParts, params);
  ...
  void testBuildSearchQueryFromTemplate3() {
    ...
    fragments.add(fragment);
    Fragment fragment2 = new Fragment("Join Clause", "Where Clause", new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>Then return {@link JdbcSearchQuery#JdbcSearchQuery(String, List)} with {@code Query} and
   *       params is {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildSearchExpr(JdbcSearchQuery,
   * SearchExpression)}
   */
  @Test
  @DisplayName(
      "Test buildSearchExpr(JdbcSearchQuery, SearchExpression); then return JdbcSearchQuery(String, List) with 'Query' and params is ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildSearchExpr(JdbcSearchQuery, SearchExpression)"
  })
  void testBuildSearchExpr_thenReturnJdbcSearchQueryWithQueryAndParamsIsArrayList() {
    ...
    // Act
    JdbcSearchQuery actualBuildSearchExprResult =
        jdbcSearchQueryBuilder.buildSearchExpr(baseQuery, null);

    // Assert
    assertSame(baseQuery, actualBuildSearchExprResult);
  }
  ...
  @Test
  @DisplayName(
      "Test buildSearchExpr(JdbcSearchQuery, SearchExpression); when DefaultInstance; then throw EValidationGap")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildSearchExpr(JdbcSearchQuery, SearchExpression)"
  ...
  void testBuildSearchExpr_whenDefaultInstance_thenThrowEValidationGap() {
    ...
    assertThrows(
        ...
        () ->
            jdbcSearchQueryBuilder.buildSearchExpr(
                baseQuery, SearchExpression.getDefaultInstance()));
  }

  /**
   * Test {@link JdbcSearchQueryBuilder#buildLogicalExpr(JdbcSearchQuery, LogicalExpression)}.
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildLogicalExpr(JdbcSearchQuery,
   * LogicalExpression)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildLogicalExpr(JdbcSearchQuery, LogicalExpression)"
  })
  void testBuildLogicalExpr() {
    // Arrange
    JdbcSearchQueryBuilder jdbcSearchQueryBuilder = new JdbcSearchQueryBuilder();
    JdbcSearchQuery baseQuery =
        new JdbcSearchQuery(
            "Invalid logical expression (operator is missing or not recognised)",
            new ArrayList<>());
    ...
    assertThrows(
        EValidationGap.class,
        () ->
            jdbcSearchQueryBuilder.buildLogicalExpr(
                baseQuery, LogicalExpression.getDefaultInstance()));
  }
  ...
  @Test
  @DisplayName(
      "Test buildLogicalExpr(JdbcSearchQuery, LogicalExpression); then throw EValidationGap")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildLogicalExpr(JdbcSearchQuery, LogicalExpression)"
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildSearchTerm(JdbcSearchQuery,
   * SearchTerm)}
   */
  @Test
  @DisplayName(
      "Test buildSearchTerm(JdbcSearchQuery, SearchTerm); when DefaultInstance; then throw EValidationGap")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildSearchTerm(JdbcSearchQuery, SearchTerm)"
  })
  ...
  /**
   * Test {@link JdbcSearchQueryBuilder#buildLogicalAndOr(JdbcSearchQuery, LogicalExpression,
   * String)}.
   *
   * <ul>
   *   <li>Then return Query is empty string.
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildLogicalAndOr(JdbcSearchQuery,
   * LogicalExpression, String)}
   */
  @Test
  @DisplayName(
      "Test buildLogicalAndOr(JdbcSearchQuery, LogicalExpression, String); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testBuildLogicalAndOr_thenReturnQueryIsEmptyString() {
    ...
    // Act
    JdbcSearchQuery actualBuildLogicalAndOrResult =
        jdbcSearchQueryBuilder.buildLogicalAndOr(
            baseQuery, LogicalExpression.getDefaultInstance(), "Op Word");
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildLogicalNot(JdbcSearchQuery,
   * LogicalExpression)}
   */
  @Test
  @DisplayName(
      "Test buildLogicalNot(JdbcSearchQuery, LogicalExpression); then throw EValidationGap")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildLogicalNot(JdbcSearchQuery, LogicalExpression)"
  })
  void testBuildLogicalNot_thenThrowEValidationGap() {
    ...
    assertThrows(
        EValidationGap.class,
        () ->
            jdbcSearchQueryBuilder.buildLogicalNot(
                baseQuery, LogicalExpression.getDefaultInstance()));
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildExistsTerm(JdbcSearchQuery,
   * SearchTerm)}
   */
  @Test
  @DisplayName(
      "Test buildExistsTerm(JdbcSearchQuery, SearchTerm); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildExistsTerm(JdbcSearchQuery, SearchTerm)"
  })
  void testBuildExistsTerm_thenReturnQueryIsEmptyString() {
    ...
    // Act
    JdbcSearchQuery actualBuildExistsTermResult =
        jdbcSearchQueryBuilder.buildExistsTerm(baseQuery, SearchTerm.getDefaultInstance());
   ...
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildEqualsTerm(JdbcSearchQuery,
   * SearchTerm)}
   */
  @Test
  @DisplayName("Test buildEqualsTerm(JdbcSearchQuery, SearchTerm)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildEqualsTerm(JdbcSearchQuery, SearchTerm)"
  })
   ...
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildNotEqualsTerm(JdbcSearchQuery,
   * SearchTerm)}
   */
  @Test
  @DisplayName("Test buildNotEqualsTerm(JdbcSearchQuery, SearchTerm)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildNotEqualsTerm(JdbcSearchQuery, SearchTerm)"
  })
   ...
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildInequalityTerm(JdbcSearchQuery,
   * SearchTerm)}
   */
  @Test
  @DisplayName("Test buildInequalityTerm(JdbcSearchQuery, SearchTerm)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildInequalityTerm(JdbcSearchQuery, SearchTerm)"
  })
   ...
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildInTerm(JdbcSearchQuery, SearchTerm)}
   */
  @Test
  @DisplayName("Test buildInTerm(JdbcSearchQuery, SearchTerm)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildInTerm(JdbcSearchQuery, SearchTerm)"
  })
  ...
  /**
   * Test {@link
   * JdbcSearchQueryBuilder#buildSearchTermFromTemplatesForExistsOperator(JdbcSearchQuery,
   * SearchTerm, String, String, Stream)}.
   *
   * <ul>
   *   <li>Then return Query is empty string.
   * </ul>
  ...
  @Test
  @DisplayName(
      "Test buildSearchTermFromTemplatesForExistsOperator(JdbcSearchQuery, SearchTerm, String, String, Stream); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testBuildSearchTermFromTemplatesForExistsOperator_thenReturnQueryIsEmptyString() {
    ...
    // Act
    JdbcSearchQuery actualBuildSearchTermFromTemplatesForExistsOperatorResult =
        jdbcSearchQueryBuilder.buildSearchTermFromTemplatesForExistsOperator(
            baseQuery, searchTerm, "Join Template", "Where Template", params);

    // Assert
    assertEquals("", actualBuildSearchTermFromTemplatesForExistsOperatorResult.getQuery());
    List<Fragment> fragments =
        actualBuildSearchTermFromTemplatesForExistsOperatorResult.getFragments();
    assertEquals(1, fragments.size());
    Fragment getResult = fragments.get(0);
    ...
    assertEquals(
        1, actualBuildSearchTermFromTemplatesForExistsOperatorResult.getNextSubQueryNumber());
    assertTrue(actualBuildSearchTermFromTemplatesForExistsOperatorResult.getParams().isEmpty());
    assertTrue(getResult.getParams().isEmpty());
  }

  /**
   * Test {@link JdbcSearchQueryBuilder#buildSearchTermFromTemplates(JdbcSearchQuery, SearchTerm,
   * String, String, Stream)}.
   *
   * <p>Method under test: {@link
   * JdbcSearchQueryBuilder#buildSearchTermFromTemplates(JdbcSearchQuery, SearchTerm, String,
   * String, Stream)}
   */
  @Test
  @DisplayName(
      "Test buildSearchTermFromTemplates(JdbcSearchQuery, SearchTerm, String, String, Stream)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testBuildSearchTermFromTemplates() {
    ...
    assertThrows(
        EValidationGap.class,
        () ->
            jdbcSearchQueryBuilder.buildSearchTermFromTemplates(
                baseQuery, searchTerm, "Join Template", "Where Template", params));
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildAsOfCondition(JdbcSearchQuery,
   * SearchParameters)}
   */
  @Test
  @DisplayName(
      "Test buildAsOfCondition(JdbcSearchQuery, SearchParameters); then return JdbcSearchQuery(String, List) with 'Query' and params is ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildAsOfCondition(JdbcSearchQuery, SearchParameters)"
  })
  void testBuildAsOfCondition_thenReturnJdbcSearchQueryWithQueryAndParamsIsArrayList() {
    ...
    // Act
    JdbcSearchQuery actualBuildAsOfConditionResult =
        jdbcSearchQueryBuilder.buildAsOfCondition(baseQuery, SearchParameters.getDefaultInstance());

    // Assert
    assertSame(baseQuery, actualBuildAsOfConditionResult);
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildPriorVersions(JdbcSearchQuery,
   * SearchParameters)}
   */
  @Test
  @DisplayName(
      "Test buildPriorVersions(JdbcSearchQuery, SearchParameters); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildPriorVersions(JdbcSearchQuery, SearchParameters)"
  })
  void testBuildPriorVersions_thenReturnQueryIsEmptyString() {
    ...
    // Act
    JdbcSearchQuery actualBuildPriorVersionsResult =
        jdbcSearchQueryBuilder.buildPriorVersions(baseQuery, SearchParameters.getDefaultInstance());
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildPriorTags(JdbcSearchQuery,
   * SearchParameters)}
   */
  @Test
  @DisplayName(
      "Test buildPriorTags(JdbcSearchQuery, SearchParameters); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildPriorTags(JdbcSearchQuery, SearchParameters)"
  })
  void testBuildPriorTags_thenReturnQueryIsEmptyString() {
    ...
    // Act
    JdbcSearchQuery actualBuildPriorTagsResult =
        jdbcSearchQueryBuilder.buildPriorTags(baseQuery, SearchParameters.getDefaultInstance());
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQueryBuilder#buildPriorFragment(JdbcSearchQuery,
   * Fragment)}
   */
  @Test
  @DisplayName(
      "Test buildPriorFragment(JdbcSearchQuery, Fragment); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "JdbcSearchQuery JdbcSearchQueryBuilder.buildPriorFragment(JdbcSearchQuery, Fragment)"
  })
  void testBuildPriorFragment_thenReturnQueryIsEmptyString() {
    ...
    // Act
    JdbcSearchQuery actualBuildPriorFragmentResult =
        jdbcSearchQueryBuilder.buildPriorFragment(baseQuery, fragment);
