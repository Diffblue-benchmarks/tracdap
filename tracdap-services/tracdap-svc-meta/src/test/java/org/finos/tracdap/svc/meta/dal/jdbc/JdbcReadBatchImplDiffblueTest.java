...
class JdbcReadBatchImplDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test lookupObjectPks(Connection, short, UUID[]); given array of Object with 'Row'; then calls execute()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long[] JdbcReadBatchImpl.lookupObjectPks(Connection, short, UUID[])"})
  void testLookupObjectPks_givenArrayOfObjectWithRow_thenCallsExecute() throws SQLException {
    // Arrange
    JdbcReadBatchImpl jdbcReadBatchImpl = new JdbcReadBatchImpl(new OracleDialect());
   ...
   *
   * <ul>
   *   <li>When array of {@link UUID} with randomUUID.
  ...
  @Test
  @DisplayName(
      "Test lookupObjectPks(Connection, short, UUID[]); when array of UUID with randomUUID; then calls addBatch()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long[] JdbcReadBatchImpl.lookupObjectPks(Connection, short, UUID[])"})
  void testLookupObjectPks_whenArrayOfUuidWithRandomUUID_thenCallsAddBatch() throws SQLException {
    // Arrange
    JdbcReadBatchImpl jdbcReadBatchImpl = new JdbcReadBatchImpl(new OracleDialect());
  ...
  @Test
  @DisplayName(
      "Test lookupDefinitionPk(Connection, short, long[], int[]); given array of Object with 'Row'; then calls execute()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "long[] JdbcReadBatchImpl.lookupDefinitionPk(Connection, short, long[], int[])"
  })
  void testLookupDefinitionPk_givenArrayOfObjectWithRow_thenCallsExecute() throws SQLException {
    // Arrange
    JdbcReadBatchImpl jdbcReadBatchImpl = new JdbcReadBatchImpl(new OracleDialect());
   ...
   *
   * <ul>
   *   <li>When array of {@code long} with one and minus one.
   *   <li>Then calls {@link PreparedStatement#addBatch()}.
   * </ul>
   *
   * <p>Method under test: {@link JdbcReadBatchImpl#lookupDefinitionPk(Connection, short, long[],
  ...
  @Test
  @DisplayName(
      "Test lookupDefinitionPk(Connection, short, long[], int[]); when array of long with one and minus one; then calls addBatch()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "long[] JdbcReadBatchImpl.lookupDefinitionPk(Connection, short, long[], int[])"
  })
  void testLookupDefinitionPk_whenArrayOfLongWithOneAndMinusOne_thenCallsAddBatch()
      throws SQLException {
    // Arrange
    JdbcReadBatchImpl jdbcReadBatchImpl = new JdbcReadBatchImpl(new OracleDialect());
  ...
  @Test
  @DisplayName(
      "Test lookupTagPk(Connection, short, long[], int[]); given array of Object with 'Row'; when empty array of long; then calls execute()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long[] JdbcReadBatchImpl.lookupTagPk(Connection, short, long[], int[])"})
  void testLookupTagPk_givenArrayOfObjectWithRow_whenEmptyArrayOfLong_thenCallsExecute()
      throws SQLException {
    // Arrange
    JdbcReadBatchImpl jdbcReadBatchImpl = new JdbcReadBatchImpl(new OracleDialect());
  ...
  @Test
  @DisplayName(
      "Test lookupTagPk(Connection, short, long[], int[]); when array of long with one and minus one; then calls addBatch()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"long[] JdbcReadBatchImpl.lookupTagPk(Connection, short, long[], int[])"})
  void testLookupTagPk_whenArrayOfLongWithOneAndMinusOne_thenCallsAddBatch() throws SQLException {
    // Arrange
    JdbcReadBatchImpl jdbcReadBatchImpl = new JdbcReadBatchImpl(new OracleDialect());
