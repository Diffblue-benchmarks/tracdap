...
class PostgreSqlDialectDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link PostgreSqlDialect}
   */
  @Test
   ...
   * <p>
   * Method under test: {@link PostgreSqlDialect#mapDialectErrorCode(SQLException)}
   */
  @Test
   ...
   */
  @Test
  @DisplayName("Test prepareMappingTable(Connection); given SQLException(); then throw SQLException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PostgreSqlDialect.prepareMappingTable(Connection)"})
  void testPrepareMappingTable_givenSQLException_thenThrowSQLException() throws SQLException {
    // Arrange
    PostgreSqlDialect postgreSqlDialect = new PostgreSqlDialect();
   ...
   */
  @Test
  @DisplayName("Test prepareMappingTable(Connection); then throw NumberFormatException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void PostgreSqlDialect.prepareMappingTable(Connection)"})
  void testPrepareMappingTable_thenThrowNumberFormatException() throws SQLException {
    // Arrange
    PostgreSqlDialect postgreSqlDialect = new PostgreSqlDialect();
    Statement statement = mock(Statement.class);
