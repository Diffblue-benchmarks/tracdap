...
class MetadataBatchUpdateDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MetadataBatchUpdate.<init>(List, List, List, List, List)",
    "List MetadataBatchUpdate.getNewObjects()",
    "List MetadataBatchUpdate.getNewTags()",
    "List MetadataBatchUpdate.getNewVersions()",
    "List MetadataBatchUpdate.getPreallocatedIds()",
  ...
  void testGettersAndSetters() {
    ...
    // Act
    MetadataBatchUpdate actualMetadataBatchUpdate =
        new MetadataBatchUpdate(
   ...
   *
   * <p>Method under test: {@link MetadataBatchUpdate#toString()}
   */
  @Test
  ...
  void testToString() {
    ...
    MetadataBatchUpdate metadataBatchUpdate =
        new MetadataBatchUpdate(
            preallocatedIds, preallocatedObjects, newObjects, newVersions, new ArrayList<>());

    // Act and Assert
    assertEquals(
        "{preallocatedIds = 0, preallocatedObjects = 0, newObjects = 0, newVersions = 0, newTags = 0}",
        metadataBatchUpdate.toString());
  }
  ...
  void testToString_thenReturnAString() {
    ...
    MetadataBatchUpdate metadataBatchUpdate =
        new MetadataBatchUpdate(
            null, preallocatedObjects, newObjects, newVersions, new ArrayList<>());

    // Act and Assert
    assertEquals(
        "{preallocatedIds = (null), preallocatedObjects = (null), newObjects = (null), newVersions = (null),"
            + " newTags = (null)}",
        metadataBatchUpdate.toString());
  }
}
