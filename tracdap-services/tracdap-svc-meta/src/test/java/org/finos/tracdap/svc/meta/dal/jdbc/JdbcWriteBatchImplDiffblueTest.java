...
class JdbcWriteBatchImplDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test writeObjectDefinition(Connection, short, long[], ObjectParts); given array of Object with '42'; then throw JdbcException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "long[] JdbcWriteBatchImpl.writeObjectDefinition(Connection, short, long[], ObjectParts)"
  })
  void testWriteObjectDefinition_givenArrayOfObjectWith42_thenThrowJdbcException()
      throws SQLException {
    // Arrange
    OracleDialect dialect = new OracleDialect();
    JdbcWriteBatchImpl jdbcWriteBatchImpl =
  ...
  @Test
  @DisplayName(
      "Test writeTagRecord(Connection, short, long[], ObjectParts); given array of Object with '42'; then throw JdbcException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "long[] JdbcWriteBatchImpl.writeTagRecord(Connection, short, long[], ObjectParts)"
  })
  void testWriteTagRecord_givenArrayOfObjectWith42_thenThrowJdbcException() throws SQLException {
    // Arrange
    OracleDialect dialect = new OracleDialect();
    JdbcWriteBatchImpl jdbcWriteBatchImpl =
        new JdbcWriteBatchImpl(dialect, new JdbcReadBatchImpl(new OracleDialect()));
