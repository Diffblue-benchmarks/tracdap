...
class JdbcSearchQueryDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void Fragment.<init>(String, String, List)",
    "String Fragment.getJoinClause()",
    "List Fragment.getParams()",
    "String Fragment.getWhereClause()"
  })
   ...
   *
   * <ul>
   *   <li>Given {@link ParamSetter}.
   *   <li>Then return Params is {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQuery#JdbcSearchQuery(String, List)}
   */
  @Test
  @DisplayName(
      "Test new JdbcSearchQuery(String, List); given ParamSetter; then return Params is ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Then return Fragments is {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQuery#JdbcSearchQuery(int, int, int, List)}
   */
  @Test
  @DisplayName(
      "Test new JdbcSearchQuery(int, int, int, List); then return Fragments is ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQuery#JdbcSearchQuery(int, int, List)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>Then return Fragments size is two.
   * </ul>
   *
   * <p>Method under test: {@link JdbcSearchQuery#JdbcSearchQuery(int, int, int, List)}
   */
  ...
  void testNewJdbcSearchQuery_thenReturnFragmentsSizeIsTwo() {
    ...
    assertSame(fragment2, fragments2.get(1));
  }
  ...
  @Test
  @DisplayName(
      "Test new JdbcSearchQuery(int, int, int, List); when ArrayList(); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void JdbcSearchQuery.<init>(int, int, int, List)"})
  ...
  @Test
  @DisplayName(
      "Test new JdbcSearchQuery(int, int, List); when ArrayList(); then return Query is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void JdbcSearchQuery.<init>(int, int, List)"})
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "List JdbcSearchQuery.getFragments()",
    "int JdbcSearchQuery.getNextAttrNumber()",
    "int JdbcSearchQuery.getNextSubQueryNumber()",
    "List JdbcSearchQuery.getParams()",
    "String JdbcSearchQuery.getQuery()",
    "int JdbcSearchQuery.getSubQueryNumber()"
  })
