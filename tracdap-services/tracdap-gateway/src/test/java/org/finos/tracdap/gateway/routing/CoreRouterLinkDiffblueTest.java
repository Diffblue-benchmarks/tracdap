...
class CoreRouterLinkDiffblueTest {
  ...
  void testChannelActive2() throws Exception {
    ...
    DefaultChannelProgressivePromise routeActivePromise =
        new DefaultChannelProgressivePromise(channel, new DefaultEventLoop());
    routeActivePromise.addListener(mock(GenericFutureListener.class));
    CoreRouterLink coreRouterLink =
        new CoreRouterLink(
