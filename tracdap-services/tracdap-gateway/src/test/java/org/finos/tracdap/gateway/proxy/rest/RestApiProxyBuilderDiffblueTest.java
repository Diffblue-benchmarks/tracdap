...
class RestApiProxyBuilderDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link RestApiProxyBuilder#RestApiProxyBuilder(Route, CoreRouterLink, int, HttpProtocol)}
   */
  @Test
  @DisplayName("Test new RestApiProxyBuilder(Route, CoreRouterLink, int, HttpProtocol); when 'null'; then return Sharable")
  ...
  void testNewRestApiProxyBuilder_whenNull_thenReturnSharable() {
    ...
    // Act and Assert
    assertTrue((new RestApiProxyBuilder(null,
