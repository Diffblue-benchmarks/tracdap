...
class SocketIdDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SocketId.<init>(NodeId, String)",
    "NodeId SocketId.nodeId()",
    "String SocketId.socket()",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(socketId.hashCode(), socketId2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link SocketId#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new SocketId(new NodeId("Name", NodeNamespace.ROOT), "Socket"),
        "Different type to SocketId");
  }
}
