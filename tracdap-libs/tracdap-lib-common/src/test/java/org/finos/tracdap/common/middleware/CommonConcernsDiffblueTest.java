...
class CommonConcernsDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link CommonConcerns#addFirst(BaseConcern)}
   */
  @Test
  @DisplayName(
      "Test addFirst(BaseConcern); given ETracInternal(String) with message is 'Not all who wander are lost'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addFirst(BaseConcern)"})
  void testAddFirst_givenETracInternalWithMessageIsNotAllWhoWanderAreLost() {
    // Arrange
    CommonGrpcConcerns commonGrpcConcerns = new CommonGrpcConcerns("Concern Name");

    GrpcConcern grpcConcern = mock(GrpcConcern.class);
    when(grpcConcern.concernName()).thenThrow(new ETracInternal("Not all who wander are lost"));

    // Act and Assert
    assertThrows(ETracInternal.class, () -> commonGrpcConcerns.addFirst(grpcConcern));
   ...
   *
   * <ul>
   *   <li>Given {@link GrpcConcern} {@link GrpcConcern#concernName()} return {@code Concern Name}.
  ...
  @Test
  @DisplayName(
      "Test addFirst(BaseConcern); given GrpcConcern concernName() return 'Concern Name'; then throw ETracInternal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addFirst(BaseConcern)"})
   ...
   *
   * <ul>
   *   <li>Then {@link CommonGrpcConcerns#CommonGrpcConcerns(String)} with {@code Concern Name}
   *       {@link CommonConcerns#stageOrder} size is one.
   * </ul>
   *
   * <p>Method under test: {@link CommonConcerns#addFirst(BaseConcern)}
   */
  @Test
  @DisplayName(
      "Test addFirst(BaseConcern); then CommonGrpcConcerns(String) with 'Concern Name' stageOrder size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addFirst(BaseConcern)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link CommonConcerns#addLast(BaseConcern)}
   */
  @Test
  @DisplayName(
      "Test addLast(BaseConcern); given ETracInternal(String) with message is 'Not all who wander are lost'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addLast(BaseConcern)"})
  void testAddLast_givenETracInternalWithMessageIsNotAllWhoWanderAreLost() {
    // Arrange
    CommonGrpcConcerns commonGrpcConcerns = new CommonGrpcConcerns("Concern Name");
    ...
    // Act and Assert
    assertThrows(ETracInternal.class, () -> commonGrpcConcerns.addLast(grpcConcern));
    verify(grpcConcern).concernName();
  }
  ...
  @Test
  @DisplayName(
      "Test addLast(BaseConcern); given GrpcConcern concernName() return 'Concern Name'; then throw ETracInternal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addLast(BaseConcern)"})
  ...
  @Test
  @DisplayName(
      "Test addLast(BaseConcern); then CommonGrpcConcerns(String) with 'Concern Name' stageOrder size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addLast(BaseConcern)"})
   ...
   *
   * <ul>
   *   <li>Given {@link CommonGrpcConcerns#CommonGrpcConcerns(String)} with {@code Concern Name}.
   *   <li>Then throw {@link ETracInternal}.
   * </ul>
   *
   * <p>Method under test: {@link CommonConcerns#addBefore(String, BaseConcern)}
   */
  @Test
  @DisplayName(
      "Test addBefore(String, BaseConcern); given CommonGrpcConcerns(String) with 'Concern Name'; then throw ETracInternal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @Test
  @DisplayName(
      "Test addBefore(String, BaseConcern); given ETracInternal(String) with message is 'Not all who wander are lost'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addBefore(String, BaseConcern)"})
  void testAddBefore_givenETracInternalWithMessageIsNotAllWhoWanderAreLost() {
    // Arrange
    CommonGrpcConcerns commonGrpcConcerns = new CommonGrpcConcerns("Concern Name");
  ...
  @Test
  @DisplayName(
      "Test addBefore(String, BaseConcern); given GrpcConcern concernName() return 'Concern Name'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addBefore(String, BaseConcern)"})
   ...
   * <ul>
   *   <li>Then {@link CommonGrpcConcerns#CommonGrpcConcerns(String)} with {@code Concern Name}
   *       {@link CommonConcerns#stageOrder} size is two.
   * </ul>
   *
   * <p>Method under test: {@link CommonConcerns#addBefore(String, BaseConcern)}
   */
  @Test
  @DisplayName(
      "Test addBefore(String, BaseConcern); then CommonGrpcConcerns(String) with 'Concern Name' stageOrder size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addBefore(String, BaseConcern)"})
  void testAddBefore_thenCommonGrpcConcernsWithConcernNameStageOrderSizeIsTwo() {
    ...
    // Act
    CommonConcerns<GrpcConcern> actualAddBeforeResult =
        commonGrpcConcerns.addBefore("42", grpcConcern2);
   ...
   * </ul>
   *
   * <p>Method under test: {@link CommonConcerns#addAfter(String, BaseConcern)}
   */
  @Test
  @DisplayName(
      "Test addAfter(String, BaseConcern); given CommonGrpcConcerns(String) with 'Concern Name'; then throw ETracInternal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  @Test
  @DisplayName(
      "Test addAfter(String, BaseConcern); given ETracInternal(String) with message is 'Not all who wander are lost'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addAfter(String, BaseConcern)"})
  void testAddAfter_givenETracInternalWithMessageIsNotAllWhoWanderAreLost() {
    // Arrange
    CommonGrpcConcerns commonGrpcConcerns = new CommonGrpcConcerns("Concern Name");
  ...
  @Test
  @DisplayName(
      "Test addAfter(String, BaseConcern); given GrpcConcern concernName() return 'Concern Name'; then throw ETracInternal")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addAfter(String, BaseConcern)"})
  ...
  @Test
  @DisplayName(
      "Test addAfter(String, BaseConcern); then CommonGrpcConcerns(String) with 'Concern Name' stageOrder size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"CommonConcerns CommonConcerns.addAfter(String, BaseConcern)"})
  void testAddAfter_thenCommonGrpcConcernsWithConcernNameStageOrderSizeIsTwo() {
    ...
    // Act
    CommonConcerns<GrpcConcern> actualAddAfterResult =
        commonGrpcConcerns.addAfter("42", grpcConcern2);
   ...
   *
   * <p>Method under test: {@link CommonConcerns#stageNames()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link CommonConcerns#concernName()}
   */
  @Test
