...
class TracPluginDiffblueTest {
  /**
   * Test {@link TracPlugin#createService(Class, PluginConfig, ConfigManager)} with {@code
   * serviceClass}, {@code config}, {@code configManager}.
   *
   * <p>Method under test: {@link TracPlugin#createService(Class, PluginConfig, ConfigManager)}
   */
  @Test
  @DisplayName(
      "Test createService(Class, PluginConfig, ConfigManager) with 'serviceClass', 'config', 'configManager'")
  ...
  void testCreateServiceWithServiceClassConfigConfigManager() {
    ...
    assertThrows(
        ...
        () -> localConfigPlugin.createService(serviceClass, config, configManager));
  }

  /**
   * Test {@link TracPlugin#createService(String, Properties, ConfigManager)} with {@code
   * serviceName}, {@code properties}, {@code configManager}.
   *
   * <p>Method under test: {@link TracPlugin#createService(String, Properties, ConfigManager)}
   */
  @Test
  @DisplayName(
  ...
  void testCreateServiceWithServiceNamePropertiesConfigManager() {
    ...
    assertThrows(
        ...
        () -> localConfigPlugin.createService("Service Name", properties, configManager));
  }

  /**
   * Test {@link TracPlugin#createConfigService(Class, PluginConfig)} with {@code serviceClass},
   * {@code config}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link TracPlugin#createConfigService(Class, PluginConfig)}
   */
  @Test
  @DisplayName(
      "Test createConfigService(Class, PluginConfig) with 'serviceClass', 'config'; then throw IllegalArgumentException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  /**
   * Test {@link TracPlugin#createConfigService(String, Properties)} with {@code serviceName},
   * {@code properties}.
   *
   * <p>Method under test: {@link TracPlugin#createConfigService(String, Properties)}
   */
  @Test
  ...
  void testCreateConfigServiceWithServiceNameProperties() {
    ...
    assertThrows(
        EPluginNotAvailable.class,
        () -> coreDataPlugin.createConfigService("Service Name", new Properties()));
  }

  /**
   * Test {@link TracPlugin#protocols(Class)}.
   *
   * <p>Method under test: {@link TracPlugin#protocols(Class)}
   */
  @Test
