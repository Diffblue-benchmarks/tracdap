...
class PluginServiceInfoDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void PluginServiceInfo.<init>(Class, String, List)",
    "List PluginServiceInfo.protocols()",
    "Class PluginServiceInfo.serviceClass()",
    "String PluginServiceInfo.serviceName()"
  })
  void testGettersAndSetters() {
    ...
    // Act
    PluginServiceInfo actualPluginServiceInfo =
        new PluginServiceInfo(serviceClass, "Service Name", protocols);
