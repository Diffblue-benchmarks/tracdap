...
class RoutingUtilsDiffblueTest {
   ...
   *   <li>Then throw {@link EConfig}.</li>
   * </ul>
   * <p>
   * Method under test: {@link RoutingUtils#serviceTarget(PlatformConfig, String)}
   */
  @Test
  @DisplayName("Test serviceTarget(PlatformConfig, String); when DefaultInstance; then throw EConfig")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"org.finos.tracdap.config.RoutingTarget RoutingUtils.serviceTarget(PlatformConfig, String)"})
   ...
   * Test {@link RoutingUtils#serviceTarget(PlatformConfig, String)}.
   * <ul>
   *   <li>When {@code Missing or invalid config: services.%s}.</li>
   *   <li>Then throw {@link EConfig}.</li>
   * </ul>
   * <p>
   * Method under test: {@link RoutingUtils#serviceTarget(PlatformConfig, String)}
   */
  @Test
  @DisplayName("Test serviceTarget(PlatformConfig, String); when 'Missing or invalid config: services.%s'; then throw EConfig")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"org.finos.tracdap.config.RoutingTarget RoutingUtils.serviceTarget(PlatformConfig, String)"})
