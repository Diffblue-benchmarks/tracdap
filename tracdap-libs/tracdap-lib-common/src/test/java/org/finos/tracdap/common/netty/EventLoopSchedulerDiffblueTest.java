...
class EventLoopSchedulerDiffblueTest {
   ...
   * <ul>
   *   <li>Given preferLoopAffinity {@link EventLoopOffloadTracker} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link EventLoopScheduler#newChooser(EventExecutor[])}
   */
  @Test
  @DisplayName("Test newChooser(EventExecutor[]); given preferLoopAffinity EventLoopOffloadTracker (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"EventExecutorChooserFactory.EventExecutorChooser EventLoopScheduler.newChooser(EventExecutor[])"})
   ...
   * Test {@link EventLoopScheduler#newChooser(EventExecutor[])}.
   * <ul>
   *   <li>Given preferLoopAffinity.</li>
   *   <li>Then return next is {@link DefaultEventLoop#DefaultEventLoop()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link EventLoopScheduler#newChooser(EventExecutor[])}
   */
  @Test
  @DisplayName("Test newChooser(EventExecutor[]); given preferLoopAffinity; then return next is DefaultEventLoop()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"EventExecutorChooserFactory.EventExecutorChooser EventLoopScheduler.newChooser(EventExecutor[])"})
