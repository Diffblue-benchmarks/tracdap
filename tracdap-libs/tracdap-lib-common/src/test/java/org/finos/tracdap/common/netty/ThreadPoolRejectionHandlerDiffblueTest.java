...
class ThreadPoolRejectionHandlerDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test rejectedExecution(Runnable, ThreadPoolExecutor); then throw RejectedExecutionException")
  ...
  void testRejectedExecution_thenThrowRejectedExecutionException() {
    ...
    ThreadPoolExecutor executor = NettyHelpers.threadPoolExecutor("Thread Pool Name", 1, 3, 3, 1L);
