...
class ITracExtensionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ITracExtension#configExtensions()}
   */
  @Test
  ...
  void testConfigExtensions() {
    // Arrange and Act
    List<FileDescriptor> actualConfigExtensionsResult = (new TestConfigExtension()).configExtensions();
   ...
   * <p>
   * Method under test: {@link ITracExtension#addServiceConcerns(CommonConcerns, ConfigManager, String)}
   */
  @Test
  @DisplayName("Test addServiceConcerns(CommonConcerns, ConfigManager, String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CommonConcerns ITracExtension.addServiceConcerns(CommonConcerns, ConfigManager, String)"})
   ...
   * <p>
   * Method under test: {@link ITracExtension#addGatewayConcerns(CommonConcerns, ConfigManager)}
   */
  @Test
  @DisplayName("Test addGatewayConcerns(CommonConcerns, ConfigManager)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CommonConcerns ITracExtension.addGatewayConcerns(CommonConcerns, ConfigManager)"})
