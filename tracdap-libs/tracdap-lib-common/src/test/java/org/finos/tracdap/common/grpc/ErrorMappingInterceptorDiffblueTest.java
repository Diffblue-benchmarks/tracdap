...
class ErrorMappingInterceptorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ErrorMappingInterceptor#interceptCall(ServerCall, Metadata, ServerCallHandler)}
   */
  @Test
  ...
  void testInterceptCall() {
    ...
    when(next.startCall(Mockito.<ServerCall<Object, Object>>any(), Mockito.<Metadata>any()))
        .thenReturn(new DelayedExecutionListener<>(call, new Metadata(), mock(ServerCallHandler.class)));
