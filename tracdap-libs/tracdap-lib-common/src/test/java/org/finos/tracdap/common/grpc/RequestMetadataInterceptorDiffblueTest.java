...
class RequestMetadataInterceptorDiffblueTest {
  /**
   * Test {@link RequestMetadataInterceptor#interceptCall(ServerCall, Metadata, ServerCallHandler)}.
   * <p>
   * Method under test: {@link RequestMetadataInterceptor#interceptCall(ServerCall, Metadata, ServerCallHandler)}
   */
  @Test
  @DisplayName("Test interceptCall(ServerCall, Metadata, ServerCallHandler)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "ServerCall.Listener RequestMetadataInterceptor.interceptCall(ServerCall, Metadata, ServerCallHandler)"})
