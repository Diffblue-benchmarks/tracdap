...
class ClientLoggingInterceptorDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "io.grpc.ClientCall ClientLoggingInterceptor.interceptCall(MethodDescriptor, CallOptions, Channel)"
  })
  ...
  @Test
  @DisplayName(
      "Test interceptCall(MethodDescriptor, CallOptions, Channel); when MethodDescriptor getServiceName() return 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "io.grpc.ClientCall ClientLoggingInterceptor.interceptCall(MethodDescriptor, CallOptions, Channel)"
  })
  void testInterceptCall_whenMethodDescriptorGetServiceNameReturnNull() {
    // Arrange
    Class<Object> serviceClass = Object.class;
    ClientLoggingInterceptor clientLoggingInterceptor = new ClientLoggingInterceptor(serviceClass);
