...
class ProtocolNegotiatorDiffblueTest {
   ...
   *
   * <ul>
   *   <li>When {@link CommonNettyConcerns#CommonNettyConcerns(String)} with {@code Concern Name}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test new ProtocolNegotiator(ProtocolHandler, NettyConcern); when CommonNettyConcerns(String) with 'Concern Name'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProtocolNegotiator.<init>(ProtocolHandler, NettyConcern)"})
  void testNewProtocolNegotiator_whenCommonNettyConcernsWithConcernName() {
    // Arrange
    ProtocolHandler mainHandler = ProtocolHandler.create();

    // Act
    ProtocolNegotiator actualProtocolNegotiator =
        new ProtocolNegotiator(mainHandler, new CommonNettyConcerns("Concern Name"));
  ...
  @Test
  @DisplayName(
      "Test new ProtocolNegotiator(ProtocolHandler, NettyConcern); when create; then return Sharable")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProtocolNegotiator.<init>(ProtocolHandler, NettyConcern)"})
