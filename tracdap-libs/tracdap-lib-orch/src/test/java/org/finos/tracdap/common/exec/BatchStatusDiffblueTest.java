...
class BatchStatusDiffblueTest {
   ...
   * <ul>
   *   <li>When {@code Status Message}.</li>
   *   <li>Then return {@code Status Message}.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
  ...
  @MethodsUnderTest({"void BatchStatus.<init>(BatchStatusCode)", "void BatchStatus.<init>(BatchStatusCode, String)",
      "BatchStatusCode BatchStatus.getStatusCode()", "String BatchStatus.getStatusMessage()"})
   ...
   * Test getters and setters.
   * <ul>
   *   <li>When {@code STATUS_UNKNOWN}.</li>
   *   <li>Then return StatusMessage is empty string.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
   ...
   */
  @Test
  @DisplayName("Test getters and setters; when 'STATUS_UNKNOWN'; then return StatusMessage is empty string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void BatchStatus.<init>(BatchStatusCode)", "void BatchStatus.<init>(BatchStatusCode, String)",
      "BatchStatusCode BatchStatus.getStatusCode()", "String BatchStatus.getStatusMessage()"})
