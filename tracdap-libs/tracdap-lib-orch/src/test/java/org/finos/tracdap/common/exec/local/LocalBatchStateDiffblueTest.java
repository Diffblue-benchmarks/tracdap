...
class LocalBatchStateDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void LocalBatchState.<init>(String, List, long)",
    "String LocalBatchState.getBatchDir()",
    "long LocalBatchState.getPid()",
    "List LocalBatchState.getVolumes()"
  })
   ...
   *
   * <p>Method under test: {@link LocalBatchState#LocalBatchState(String)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link LocalBatchState#withVolume(String)}
   */
  @Test
  ...
  void testWithVolume() {
    // Arrange and Act
    LocalBatchState actualWithVolumeResult =
        new LocalBatchState("Batch Dir").withVolume("New Volume");
   ...
   *
   * <p>Method under test: {@link LocalBatchState#withPid(long)}
   */
  @Test
