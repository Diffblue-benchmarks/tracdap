...
class CoreOrchestratorPluginDiffblueTest {
  /**
   * Test {@link CoreOrchestratorPlugin#pluginName()}.
   *
   * <p>Method under test: {@link CoreOrchestratorPlugin#pluginName()}
   */
  @Test
  @DisplayName("Test pluginName()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String CoreOrchestratorPlugin.pluginName()"})
  void testPluginName() {
  ...
  /**
   * Test {@link CoreOrchestratorPlugin#serviceInfo()}.
   *
   * <p>Method under test: {@link CoreOrchestratorPlugin#serviceInfo()}
   */
  @Test
  @DisplayName("Test serviceInfo()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List CoreOrchestratorPlugin.serviceInfo()"})
  ...
  /**
   * Test {@link CoreOrchestratorPlugin#createService(String, Properties, ConfigManager)} with
   * {@code serviceName}, {@code properties}, {@code configManager}.
   *
   * <p>Method under test: {@link CoreOrchestratorPlugin#createService(String, Properties,
   * ConfigManager)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "java.lang.Object CoreOrchestratorPlugin.createService(String, Properties, ConfigManager)"
  })
  void testCreateServiceWithServiceNamePropertiesConfigManager() {
    ...
    assertThrows(
        ...
        () -> coreOrchestratorPlugin.createService("Service Name", properties, configManager));
  }
  ...
  void testCreateServiceWithServiceNamePropertiesConfigManager2() {
    ...
    // Act and Assert
    assertTrue(
        coreOrchestratorPlugin.createService("LOCAL_JOB_CACHE", properties, configManager)
            instanceof LocalJobCacheManager);
  }
}
