...
class CoreOrchestratorPluginDiffblueTest {
  ...
  /**
   * Test {@link CoreOrchestratorPlugin#createService(String, Properties, ConfigManager)} with {@code serviceName}, {@code properties}, {@code configManager}.
   * <p>
   * Method under test: {@link CoreOrchestratorPlugin#createService(String, Properties, ConfigManager)}
   */
  @Test
  @DisplayName("Test createService(String, Properties, ConfigManager) with 'serviceName', 'properties', 'configManager'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"java.lang.Object CoreOrchestratorPlugin.createService(String, Properties, ConfigManager)"})
