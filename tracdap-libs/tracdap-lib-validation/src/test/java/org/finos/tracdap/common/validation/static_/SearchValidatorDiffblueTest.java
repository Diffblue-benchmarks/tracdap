...
class SearchValidatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link SearchValidator#searchParameters(SearchParameters,
   * ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext SearchValidator.searchParameters(SearchParameters, ValidationContext)"
  })
   ...
   *
   * <p>Method under test: {@link SearchValidator#searchExpression(SearchExpression,
   * ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext SearchValidator.searchExpression(SearchExpression, ValidationContext)"
  })
   ...
   * </ul>
   *
   * <p>Method under test: {@link SearchValidator#searchTerm(SearchTerm, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test searchTerm(SearchTerm, ValidationContext); given ValidationContext failed() return 'true'; then calls apply(Basic)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testSearchTerm_givenValidationContextFailedReturnTrue_thenCallsApply() {
    ...
    ValidationContext validationContext4 = mock(ValidationContext.class);
    when(validationContext4.applyIf(anyBoolean(), Mockito.<Basic>any()))
        .thenReturn(validationContext3);

    ValidationContext validationContext5 = mock(ValidationContext.class);
    when(validationContext5.applyIf(anyBoolean(), Mockito.<Basic>any()))
    ...
    ValidationContext validationContext14 = mock(ValidationContext.class);
    when(validationContext14.applyIf(anyBoolean(), Mockito.<Basic>any()))
        .thenReturn(validationContext13);

    ValidationContext validationContext15 = mock(ValidationContext.class);
    when(validationContext15.applyIf(anyBoolean(), Mockito.<Basic>any()))
   ...
   *
   * <ul>
   *   <li>Then calls {@link ValidationContext#applyIf(boolean, Typed, Class)}.
   * </ul>
   *
   * <p>Method under test: {@link SearchValidator#searchTerm(SearchTerm, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test searchTerm(SearchTerm, ValidationContext); then calls applyIf(boolean, Typed, Class)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ValidationContext SearchValidator.searchTerm(SearchTerm, ValidationContext)"})
  void testSearchTerm_thenCallsApplyIf() {
    ...
    ValidationContext validationContext = mock(ValidationContext.class);
    when(validationContext.applyIf(
    ...
    ValidationContext validationContext6 = mock(ValidationContext.class);
    when(validationContext6.applyIf(anyBoolean(), Mockito.<Basic>any()))
    ...
    ValidationContext validationContext16 = mock(ValidationContext.class);
    when(validationContext16.applyIf(anyBoolean(), Mockito.<Basic>any()))
   ...
   * </ul>
   *
   * <p>Method under test: {@link SearchValidator#logicalExpression(LogicalExpression,
   * ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test logicalExpression(LogicalExpression, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext SearchValidator.logicalExpression(LogicalExpression, ValidationContext)"
  })
