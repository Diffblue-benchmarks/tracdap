...
class OrchestratorApiValidatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link OrchestratorApiValidator#validateJob(JobRequest,
   * ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext OrchestratorApiValidator.validateJob(JobRequest, ValidationContext)"
  })
   ...
   *
   * <p>Method under test: {@link OrchestratorApiValidator#submitJob(JobRequest, ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext OrchestratorApiValidator.submitJob(JobRequest, ValidationContext)"
  })
  void testSubmitJob() {
    // Arrange
    JobRequest msg = JobRequest.getDefaultInstance();
   ...
   *
   * <p>Method under test: {@link OrchestratorApiValidator#checkJob(JobStatusRequest,
   * ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext OrchestratorApiValidator.checkJob(JobStatusRequest, ValidationContext)"
  })
  void testCheckJob() {
    // Arrange
