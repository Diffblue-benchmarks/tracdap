...
class CustomVersionValidatorDiffblueTest {
  /**
   * Test {@link CustomVersionValidator#customVersion(CustomDefinition, CustomDefinition,
   * ValidationContext)}.
   *
   * <p>Method under test: {@link CustomVersionValidator#customVersion(CustomDefinition,
   * CustomDefinition, ValidationContext)}
   */
  @Test
