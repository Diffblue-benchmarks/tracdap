...
class TypeSystemValidatorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link TypeSystemValidator#typeDescriptor(TypeDescriptor, ValidationContext)}
   */
  @Test
  @DisplayName("Test typeDescriptor(TypeDescriptor, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext TypeSystemValidator.typeDescriptor(TypeDescriptor, ValidationContext)"})
  void testTypeDescriptor_whenDefaultInstance_thenCallsApply() {
    // Arrange
   ...
   * </ul>
   * <p>
   * Method under test: {@link TypeSystemValidator#value(Value, ValidationContext)}
   */
  @Test
  @DisplayName("Test value(Value, ValidationContext); when DefaultInstance; then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext TypeSystemValidator.value(Value, ValidationContext)"})
  void testValue_whenDefaultInstance_thenCallsError() {
    // Arrange
   ...
   * </ul>
   * <p>
   * Method under test: {@link TypeSystemValidator#valueWithType(Value, TypeDescriptor, ValidationContext)}
   */
  @Test
  @DisplayName("Test valueWithType(Value, TypeDescriptor, ValidationContext); then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext TypeSystemValidator.valueWithType(Value, TypeDescriptor, ValidationContext)"})
  void testValueWithType_thenCallsError() {
    // Arrange
    Value value = Value.getDefaultInstance();
   ...
   * <p>
   * Method under test: {@link TypeSystemValidator#decimalValue(DecimalValue, ValidationContext)}
   */
  @Test
  @DisplayName("Test decimalValue(DecimalValue, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext TypeSystemValidator.decimalValue(DecimalValue, ValidationContext)"})
   ...
   * <p>
   * Method under test: {@link TypeSystemValidator#dateValue(DateValue, ValidationContext)}
   */
  @Test
  @DisplayName("Test dateValue(DateValue, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext TypeSystemValidator.dateValue(DateValue, ValidationContext)"})
  void testDateValue() {
    // Arrange
   ...
   * <p>
   * Method under test: {@link TypeSystemValidator#datetimeValue(DatetimeValue, ValidationContext)}
   */
  @Test
  @DisplayName("Test datetimeValue(DatetimeValue, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext TypeSystemValidator.datetimeValue(DatetimeValue, ValidationContext)"})
