...
class TypeSystemValidatorDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test value(Value, ValidationContext); given ValidationContext; when DefaultInstance; then calls error(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ValidationContext TypeSystemValidator.value(Value, ValidationContext)"})
  void testValue_givenValidationContext_whenDefaultInstance_thenCallsError() {
    // Arrange
  ...
  @Test
  @DisplayName(
      "Test valueWithType(Value, TypeDescriptor, ValidationContext); given ValidationContext; then calls error(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext TypeSystemValidator.valueWithType(Value, TypeDescriptor, ValidationContext)"
  })
  void testValueWithType_givenValidationContext_thenCallsError() {
    // Arrange
    Value value = Value.getDefaultInstance();
