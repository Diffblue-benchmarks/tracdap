...
class DataValidatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link DataValidator#dataPart(DataDefinition.Part, ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext DataValidator.dataPart(DataDefinition.Part, ValidationContext)"
  })
  void testDataPart() {
    // Arrange
   ...
   *
   * <p>Method under test: {@link DataValidator#dataSnap(Snap, ValidationContext)}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link DataValidator#partKey(PartKey, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test partKey(PartKey, ValidationContext); given ValidationContext failed() return 'false'; then calls apply(Basic)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testPartKey_givenValidationContextFailedReturnFalse_thenCallsApply() {
    ...
    ValidationContext validationContext2 = mock(ValidationContext.class);
    when(validationContext2.applyIf(
            anyBoolean(),
            Mockito.<TypedArg<Object, Object>>any(),
            Mockito.<Class<Object>>any(),
            Mockito.<Object>any()))
    ...
    verify(validationContext7).apply(isA(Typed.class), isA(Class.class));
    verify(validationContext2)
        .applyIf(eq(true), isA(TypedArg.class), isA(Class.class), isA(Object.class));
  ...
  @Test
  @DisplayName(
      "Test partKey(PartKey, ValidationContext); given ValidationContext failed() return 'true'; then calls apply(Basic)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ValidationContext DataValidator.partKey(PartKey, ValidationContext)"})
  void testPartKey_givenValidationContextFailedReturnTrue_thenCallsApply() {
    ...
    verify(validationContext7).apply(isA(Typed.class), isA(Class.class));
    verify(validationContext2)
        .applyIf(eq(false), isA(TypedArg.class), isA(Class.class), isA(Object.class));
    verify(validationContext15).applyRepeated(isA(Typed.class), isA(Class.class));
    verify(validationContext5).failed();
    verify(validationContext19).pop();
    verify(validationContext14).pop();
