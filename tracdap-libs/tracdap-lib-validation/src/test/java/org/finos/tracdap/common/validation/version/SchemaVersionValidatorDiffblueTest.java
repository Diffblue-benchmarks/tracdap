...
class SchemaVersionValidatorDiffblueTest {
  /**
   * Test {@link SchemaVersionValidator#schema(SchemaDefinition, SchemaDefinition, ValidationContext)}.
   * <ul>
   ...
   * </ul>
   * <p>
   * Method under test: {@link SchemaVersionValidator#schema(SchemaDefinition, SchemaDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test schema(SchemaDefinition, SchemaDefinition, ValidationContext); given EUnexpected(); when ValidationContext push(FieldDescriptor) throw EUnexpected()")
   ...
   * Test {@link SchemaVersionValidator#schema(SchemaDefinition, SchemaDefinition, ValidationContext)}.
   * <ul>
   *   <li>Given {@link ValidationContext} {@link ValidationContext#apply(Version, Class)} throw {@link EUnexpected#EUnexpected()}.</li>
   *   <li>Then calls {@link ValidationContext#apply(Version, Class)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SchemaVersionValidator#schema(SchemaDefinition, SchemaDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test schema(SchemaDefinition, SchemaDefinition, ValidationContext); given ValidationContext apply(Version, Class) throw EUnexpected(); then calls apply(Version, Class)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "ValidationContext SchemaVersionValidator.schema(SchemaDefinition, SchemaDefinition, ValidationContext)"})
   ...
   */
  @Test
  @DisplayName("Test schema(SchemaDefinition, SchemaDefinition, ValidationContext); given ValidationContext pop() return ValidationContext; then calls pop()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "ValidationContext SchemaVersionValidator.schema(SchemaDefinition, SchemaDefinition, ValidationContext)"})
   ...
   */
  @Test
  @DisplayName("Test schema(SchemaDefinition, SchemaDefinition, ValidationContext); given ValidationContext pop() throw EUnexpected(); then calls pop()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "ValidationContext SchemaVersionValidator.schema(SchemaDefinition, SchemaDefinition, ValidationContext)"})
