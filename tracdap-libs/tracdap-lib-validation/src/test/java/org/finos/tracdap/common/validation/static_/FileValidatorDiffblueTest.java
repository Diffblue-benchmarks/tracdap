...
class FileValidatorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link FileValidator#file(FileDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test file(FileDefinition, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  ...
  void testFile_whenDefaultInstance_thenCallsApply() {
    ...
    when(validationContext20.apply(Mockito.<TypedArg<Object, Object>>any(), Mockito.<Class<Object>>any(),
        Mockito.<Object>any())).thenReturn(validationContext19);
   ...
   * <p>
   * Method under test: {@link FileValidator#fileType(FileType, ValidationContext)}
   */
  @Test
