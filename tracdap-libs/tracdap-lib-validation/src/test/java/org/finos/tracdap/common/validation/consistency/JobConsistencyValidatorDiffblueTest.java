...
class JobConsistencyValidatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link JobConsistencyValidator#job(JobDefinition, ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.job(JobDefinition, ValidationContext)"
  })
  void testJob() {
    // Arrange
    ...
    when(validationContext.applyRegistered())
  ...
  @Test
  @DisplayName(
      "Test job(JobDefinition, ValidationContext); given ETracInternal(String) with message is 'Not all who wander are lost'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.job(JobDefinition, ValidationContext)"
  })
  void testJob_givenETracInternalWithMessageIsNotAllWhoWanderAreLost() {
    // Arrange
    JobDefinition job = JobDefinition.getDefaultInstance();

    ValidationContext ctx = mock(ValidationContext.class);
    when(ctx.pushOneOf(Mockito.<OneofDescriptor>any()))
        .thenThrow(new ETracInternal("Not all who wander are lost"));
  ...
  @Test
  @DisplayName(
      "Test job(JobDefinition, ValidationContext); given ValidationContext pop() return ValidationContext; then calls pop()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.job(JobDefinition, ValidationContext)"
   ...
   *
   * <p>Method under test: {@link JobConsistencyValidator#importModelJob(ImportModelJob,
   * ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.importModelJob(ImportModelJob, ValidationContext)"
  })
  ...
  @Test
  @DisplayName(
      "Test importModelJob(ImportModelJob, ValidationContext); given ETracInternal(String) with message is 'Not all who wander are lost'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.importModelJob(ImportModelJob, ValidationContext)"
  })
  void testImportModelJob_givenETracInternalWithMessageIsNotAllWhoWanderAreLost() {
    // Arrange
    ImportModelJob job = ImportModelJob.getDefaultInstance();

    ValidationContext ctx = mock(ValidationContext.class);
    when(ctx.push(Mockito.<FieldDescriptor>any()))
        .thenThrow(new ETracInternal("Not all who wander are lost"));
  ...
  @Test
  @DisplayName(
      "Test importModelJob(ImportModelJob, ValidationContext); given ValidationContext pop() return ValidationContext; then calls pop()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.importModelJob(ImportModelJob, ValidationContext)"
   ...
   *
   * <p>Method under test: {@link JobConsistencyValidator#runFlowJob(RunFlowJob, ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.runFlowJob(RunFlowJob, ValidationContext)"
  })
  void testRunFlowJob() {
    // Arrange
  ...
  void testRunFlowJob2() {
    ...
    ValidationContext validationContext = mock(ValidationContext.class);
    when(validationContext.apply(Mockito.<Basic>any()))
        .thenThrow(new ETracInternal("Not all who wander are lost"));
  ...
  void testRunFlowJob5() {
    ...
    ValidationContext ctx = mock(ValidationContext.class);
    when(ctx.failed()).thenThrow(new ETracInternal("Not all who wander are lost"));
    when(ctx.push(Mockito.<FieldDescriptor>any())).thenReturn(validationContext3);
   ...
   * <ul>
   *   <li>Given {@code true}.
   *   <li>When {@link ValidationContext} {@link ValidationContext#failed()} return {@code true}.
  ...
  @Test
  @DisplayName(
      "Test runFlowJob(RunFlowJob, ValidationContext); given 'true'; when ValidationContext failed() return 'true'; then calls failed()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobConsistencyValidator.runFlowJob(RunFlowJob, ValidationContext)"
