...
class DataVersionValidatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link DataVersionValidator#data(DataDefinition, DataDefinition,
   * ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext DataVersionValidator.data(DataDefinition, DataDefinition, ValidationContext)"
  })
  void testData() {
    // Arrange
