...
class CustomValidatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link CustomValidator#custom(CustomDefinition, ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext CustomValidator.custom(CustomDefinition, ValidationContext)"
  })
  void testCustom() {
    // Arrange
