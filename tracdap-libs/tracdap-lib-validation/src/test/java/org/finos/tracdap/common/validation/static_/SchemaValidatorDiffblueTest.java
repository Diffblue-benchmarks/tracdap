...
class SchemaValidatorDiffblueTest {
  /**
   * Test {@link SchemaValidator#schema(SchemaDefinition, ValidationContext)} with {@code schema}, {@code ctx}.
   * <p>
   * Method under test: {@link SchemaValidator#schema(SchemaDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test schema(SchemaDefinition, ValidationContext) with 'schema', 'ctx'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext SchemaValidator.schema(SchemaDefinition, ValidationContext)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link SchemaValidator#tableSchema(TableSchema, ValidationContext)}
   */
  @Test
  @DisplayName("Test tableSchema(TableSchema, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext SchemaValidator.tableSchema(TableSchema, ValidationContext)"})
  void testTableSchema_whenDefaultInstance_thenCallsApply() {
    // Arrange
   ...
   * <p>
   * Method under test: {@link SchemaValidator#dynamicSchema(SchemaDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test dynamicSchema(SchemaDefinition, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext SchemaValidator.dynamicSchema(SchemaDefinition, ValidationContext)"})
  void testDynamicSchema() {
    ...
    ValidationContext validationContext3 = mock(ValidationContext.class);
    when(validationContext3.pushOneOf(Mockito.<OneofDescriptor>any())).thenReturn(validationContext2);
    ValidationContext validationContext4 = mock(ValidationContext.class);
   ...
   * </ul>
   * <p>
   * Method under test: {@link SchemaValidator#fieldSchema(FieldSchema, ValidationContext)}
   */
  @Test
  @DisplayName("Test fieldSchema(FieldSchema, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext SchemaValidator.fieldSchema(FieldSchema, ValidationContext)"})
  void testFieldSchema_whenDefaultInstance_thenCallsApply() {
    // Arrange
