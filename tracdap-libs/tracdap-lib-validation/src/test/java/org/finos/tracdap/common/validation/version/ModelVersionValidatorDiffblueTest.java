...
class ModelVersionValidatorDiffblueTest {
  /**
   * Method under test:
   * {@link ModelVersionValidator#modelVersion(ModelDefinition, ModelDefinition, ValidationContext)}
   */
  @Test
  void testModelVersion() {
    ...
    when(validationContext17.apply(Mockito.<ValidationFunction.Version<Object>>any())).thenReturn(validationContext16);
    ...
    when(validationContext20.apply(Mockito.<ValidationFunction.Version<Object>>any())).thenReturn(validationContext19);
    ...
    when(validationContext23.apply(Mockito.<ValidationFunction.Version<Object>>any())).thenReturn(validationContext22);
    ...
    // Assert
    verify(validationContext23).apply(isA(ValidationFunction.Version.class));
    verify(validationContext20).apply(isA(ValidationFunction.Version.class));
    verify(validationContext17).apply(isA(ValidationFunction.Version.class));
