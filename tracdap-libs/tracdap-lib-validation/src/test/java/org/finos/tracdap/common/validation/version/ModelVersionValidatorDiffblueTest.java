...
class ModelVersionValidatorDiffblueTest {
  /**
   * Test {@link ModelVersionValidator#modelVersion(ModelDefinition, ModelDefinition, ValidationContext)}.
   * <p>
   * Method under test: {@link ModelVersionValidator#modelVersion(ModelDefinition, ModelDefinition, ValidationContext)}
   */
  @Test
