...
class JobValidatorDiffblueTest {
   ...
   *
   * <p>Method under test: {@link JobValidator#job(JobDefinition, ValidationContext)}
   */
  @Test
  ...
  /**
   * Test {@link JobValidator#job(JobDefinition, boolean, ValidationContext)} with {@code msg},
   * {@code isClientRequest}, {@code ctx}.
   *
   * <ul>
   *   <li>When {@code false}.
   * </ul>
   *
   * <p>Method under test: {@link JobValidator#job(JobDefinition, boolean, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test job(JobDefinition, boolean, ValidationContext) with 'msg', 'isClientRequest', 'ctx'; when 'false'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobValidator.job(JobDefinition, boolean, ValidationContext)"
  })
  void testJobWithMsgIsClientRequestCtx_whenFalse() {
    ...
    when(validationContext11.pushOneOf(Mockito.<OneofDescriptor>any()))
  ...
  @Test
  @DisplayName(
      "Test job(JobDefinition, boolean, ValidationContext) with 'msg', 'isClientRequest', 'ctx'; when 'true'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobValidator.job(JobDefinition, boolean, ValidationContext)"
   ...
   *
   * <p>Method under test: {@link JobValidator#jobRequest(JobDefinition, ValidationContext)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link JobValidator#importModelJob(ImportModelJob, ValidationContext)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobValidator.importModelJob(ImportModelJob, ValidationContext)"
  })
   ...
   *
   * <p>Method under test: {@link JobValidator#runModelJob(RunModelJob, ValidationContext)}
   */
  @Test
  ...
  void testRunModelJob() {
    ...
    ValidationContext validationContext10 = mock(ValidationContext.class);
    when(validationContext10.applyMapValues(
            Mockito.<TypedArg<Object, Object>>any(),
            Mockito.<Class<Object>>any(),
            Mockito.<Object>any()))
    ...
    ValidationContext validationContext11 = mock(ValidationContext.class);
    when(validationContext11.applyMapValues(
            Mockito.<Typed<Object>>any(), Mockito.<Class<Object>>any()))
        .thenReturn(validationContext10);
    ...
    ValidationContext validationContext17 = mock(ValidationContext.class);
    when(validationContext17.applyMapValues(
            Mockito.<TypedArg<Object, Object>>any(),
            Mockito.<Class<Object>>any(),
            Mockito.<Object>any()))
    ...
    ValidationContext validationContext18 = mock(ValidationContext.class);
    when(validationContext18.applyMapValues(
            Mockito.<Typed<Object>>any(), Mockito.<Class<Object>>any()))
    ...
    when(validationContext28.apply(
            Mockito.<TypedArg<Object, Object>>any(),
            Mockito.<Class<Object>>any(),
            Mockito.<Object>any()))
    ...
    verify(validationContext17)
        .applyMapValues(isA(TypedArg.class), isA(Class.class), isA(Object.class));
   ...
   *
   * <p>Method under test: {@link JobValidator#runFlowJob(RunFlowJob, ValidationContext)}
   */
  @Test
  ...
  void testRunFlowJob() {
    ...
    ValidationContext validationContext28 = mock(ValidationContext.class);
    when(validationContext28.applyMapValues(
            Mockito.<Typed<Object>>any(), Mockito.<Class<Object>>any()))
        .thenReturn(validationContext27);

    ValidationContext validationContext29 = mock(ValidationContext.class);
    when(validationContext29.applyMapValues(
            Mockito.<TypedArg<Object, Object>>any(),
            Mockito.<Class<Object>>any(),
            Mockito.<Object>any()))
        .thenReturn(validationContext28);
    ...
    when(validationContext35.apply(
            Mockito.<TypedArg<Object, Object>>any(),
            Mockito.<Class<Object>>any(),
            Mockito.<Object>any()))
  ...
  /**
   * Test {@link JobValidator#runModelOrFlow(ValidationContext, FieldDescriptor, FieldDescriptor,
   * FieldDescriptor, FieldDescriptor)}.
   *
   * <p>Method under test: {@link JobValidator#runModelOrFlow(ValidationContext, FieldDescriptor,
   * FieldDescriptor, FieldDescriptor, FieldDescriptor)}
   */
  @Test
  @DisplayName(
      "Test runModelOrFlow(ValidationContext, FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  /**
   * Test {@link JobValidator#outputsMustBeEmpty(JobDefinition, ValidationContext)} with {@code
   * JobDefinition}, {@code ValidationContext}.
   *
   * <ul>
   *   <li>Then calls {@link ValidationContext#pop()}.
   * </ul>
   *
   * <p>Method under test: {@link JobValidator#outputsMustBeEmpty(JobDefinition, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test outputsMustBeEmpty(JobDefinition, ValidationContext) with 'JobDefinition', 'ValidationContext'; then calls pop()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext JobValidator.outputsMustBeEmpty(JobDefinition, ValidationContext)"
  })
