...
class StorageValidatorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link StorageValidator#storageDefinition(StorageDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test storageDefinition(StorageDefinition, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext StorageValidator.storageDefinition(StorageDefinition, ValidationContext)"})
   ...
   * <p>
   * Method under test: {@link StorageValidator#storageItem(StorageItem, ValidationContext)}
   */
  @Test
  @DisplayName("Test storageItem(StorageItem, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext StorageValidator.storageItem(StorageItem, ValidationContext)"})
   ...
   * <p>
   * Method under test: {@link StorageValidator#storageIncarnation(StorageIncarnation, ValidationContext)}
   */
  @Test
  @DisplayName("Test storageIncarnation(StorageIncarnation, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext StorageValidator.storageIncarnation(StorageIncarnation, ValidationContext)"})
   ...
   * <p>
   * Method under test: {@link StorageValidator#storageCopy(StorageCopy, ValidationContext)}
   */
  @Test
  @DisplayName("Test storageCopy(StorageCopy, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext StorageValidator.storageCopy(StorageCopy, ValidationContext)"})
   ...
   * <ul>
   *   <li>When {@code Data Item}.</li>
   *   <li>Then calls {@link ValidationContext#error(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link StorageValidator#dataItemKey(String, ValidationContext)}
   */
  @Test
  @DisplayName("Test dataItemKey(String, ValidationContext); when 'Data Item'; then calls error(String)")
  @Tag("MaintainedByDiffblue")
