...
class StorageVersionValidatorDiffblueTest {
   ...
   * <ul>
   *   <li>When {@link ValidationContext} {@link ValidationContext#pushRepeated(FieldDescriptor)} return {@link ValidationContext}.</li>
   *   <li>Then calls {@link ValidationContext#pop()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link StorageVersionValidator#item(StorageItem, StorageItem, ValidationContext)}
   */
  @Test
  @DisplayName("Test item(StorageItem, StorageItem, ValidationContext); when ValidationContext pushRepeated(FieldDescriptor) return ValidationContext; then calls pop()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext StorageVersionValidator.item(StorageItem, StorageItem, ValidationContext)"})
  ...
  /**
   * Test {@link StorageVersionValidator#incarnation(StorageIncarnation, StorageIncarnation, ValidationContext)}.
   * <ul>
   *   <li>Given {@link ValidationContext} {@link ValidationContext#parentMsg()} return {@code null}.</li>
   *   <li>Then calls {@link ValidationContext#apply(TypedArg, Class, Object)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link StorageVersionValidator#incarnation(StorageIncarnation, StorageIncarnation, ValidationContext)}
   */
  @Test
  @DisplayName("Test incarnation(StorageIncarnation, StorageIncarnation, ValidationContext); given ValidationContext parentMsg() return 'null'; then calls apply(TypedArg, Class, Object)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "ValidationContext StorageVersionValidator.incarnation(StorageIncarnation, StorageIncarnation, ValidationContext)"})
  void testIncarnation_givenValidationContextParentMsgReturnNull_thenCallsApply() {
    // Arrange
    ...
    // Assert
    verify(ctx).apply(isA(TypedArg.class), isA(Class.class), isNull());
   ...
   *   <li>Then calls {@link ValidationContext#apply(Version)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link StorageVersionValidator#incarnation(StorageIncarnation, StorageIncarnation, ValidationContext)}
   */
  @Test
  @DisplayName("Test incarnation(StorageIncarnation, StorageIncarnation, ValidationContext); given ValidationContext pop() return ValidationContext; then calls apply(Version)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "ValidationContext StorageVersionValidator.incarnation(StorageIncarnation, StorageIncarnation, ValidationContext)"})
  void testIncarnation_givenValidationContextPopReturnValidationContext_thenCallsApply() {
    // Arrange
    StorageIncarnation current = StorageIncarnation.getDefaultInstance();
   ...
   * </ul>
   * <p>
   * Method under test: {@link StorageVersionValidator#copy(StorageCopy, StorageCopy, ValidationContext)}
   */
  @Test
  @DisplayName("Test copy(StorageCopy, StorageCopy, ValidationContext); given ValidationContext pop() return ValidationContext; then calls apply(Version)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext StorageVersionValidator.copy(StorageCopy, StorageCopy, ValidationContext)"})
