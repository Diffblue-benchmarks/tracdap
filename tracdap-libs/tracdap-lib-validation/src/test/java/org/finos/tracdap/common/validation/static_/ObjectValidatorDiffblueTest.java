...
class ObjectValidatorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ObjectValidator#objectDefinition(ObjectDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test objectDefinition(ObjectDefinition, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectValidator.objectDefinition(ObjectDefinition, ValidationContext)"})
  void testObjectDefinition() {
    ...
    when(validationContext9.pushOneOf(Mockito.<OneofDescriptor>any())).thenReturn(validationContext8);
   ...
   * </ul>
   * <p>
   * Method under test: {@link ObjectValidator#objectType(ObjectDefinition, ObjectType, ValidationContext)}
   */
  @Test
  @DisplayName("Test objectType(ObjectDefinition, ObjectType, ValidationContext); when DefaultInstance; then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectValidator.objectType(ObjectDefinition, ObjectType, ValidationContext)"})
