...
class ModelConsistencyValidatorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ModelConsistencyValidator#modelDefinition(ModelDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelDefinition(ModelDefinition, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ModelConsistencyValidator.modelDefinition(ModelDefinition, ValidationContext)"})
