...
class ModelValidatorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ModelValidator#model(ModelDefinition, ValidationContext)}
   */
  @Test
  ...
  void testModel() {
    ...
    when(validationContext3.applyMapKeys(Mockito.<Typed<String>>any())).thenReturn(validationContext2);
    ...
    when(validationContext17.applyMapKeys(Mockito.<Typed<String>>any())).thenReturn(validationContext16);
  ...
  /**
   * Test {@link ModelValidator#modelDetails(FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)}.
   * <p>
   * Method under test: {@link ModelValidator#modelDetails(FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelDetails(FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
   ...
   * </ul>
   * <p>
   * Method under test: {@link ModelValidator#modelParameter(ModelParameter, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelParameter(ModelParameter, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ModelValidator.modelParameter(ModelParameter, ValidationContext)"})
  void testModelParameter_whenDefaultInstance_thenCallsApply() {
    // Arrange
   ...
   * </ul>
   * <p>
   * Method under test: {@link ModelValidator#modelInputSchema(ModelInputSchema, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelInputSchema(ModelInputSchema, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ModelValidator.modelInputSchema(ModelInputSchema, ValidationContext)"})
  void testModelInputSchema_whenDefaultInstance_thenCallsApply() {
    // Arrange
   ...
   * </ul>
   * <p>
   * Method under test: {@link ModelValidator#modelOutputSchema(ModelOutputSchema, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelOutputSchema(ModelOutputSchema, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ModelValidator.modelOutputSchema(ModelOutputSchema, ValidationContext)"})
  void testModelOutputSchema_whenDefaultInstance_thenCallsApply() {
    // Arrange
   ...
   * <ul>
   *   <li>When {@code Model Entry Point}.</li>
   *   <li>Then calls {@link ValidationContext#error(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ModelValidator#modelEntryPoint(String, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelEntryPoint(String, ValidationContext); when 'Model Entry Point'; then calls error(String)")
  @Tag("MaintainedByDiffblue")
   ...
   *   <li>When {@code Model Version}.</li>
   *   <li>Then calls {@link ValidationContext#error(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ModelValidator#modelVersion(String, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelVersion(String, ValidationContext); given ValidationContext; when 'Model Version'; then calls error(String)")
  @Tag("MaintainedByDiffblue")
