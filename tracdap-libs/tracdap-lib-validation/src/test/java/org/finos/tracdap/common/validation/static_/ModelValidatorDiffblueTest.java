...
class ModelValidatorDiffblueTest {
  /**
   * Test {@link ModelValidator#model(ModelDefinition, ValidationContext)}.
   *
   * <p>Method under test: {@link ModelValidator#model(ModelDefinition, ValidationContext)}
   */
  @Test
  @DisplayName("Test model(ModelDefinition, ValidationContext)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ValidationContext ModelValidator.model(ModelDefinition, ValidationContext)"})
  void testModel() {
    // Arrange
    ...
    when(validationContext9.applyMapValues(
            Mockito.<Typed<Object>>any(), Mockito.<Class<Object>>any()))
    ...
    when(validationContext16.applyMapValues(
            Mockito.<Typed<Object>>any(), Mockito.<Class<Object>>any()))
        .thenReturn(validationContext15);

    ValidationContext validationContext17 = mock(ValidationContext.class);
    when(validationContext17.applyMapKeys(Mockito.<Typed<String>>any()))
    ...
    when(validationContext27.apply(Mockito.<Typed<String>>any())).thenReturn(validationContext26);
    ...
    when(validationContext29.push(Mockito.<FieldDescriptor>any())).thenReturn(validationContext28);
    ...
    when(validationContext31.apply(Mockito.<Typed<String>>any())).thenReturn(validationContext30);
    ...
    when(validationContext33.push(Mockito.<FieldDescriptor>any())).thenReturn(validationContext32);
    ...
    when(validationContext35.apply(Mockito.<Typed<String>>any())).thenReturn(validationContext34);
    ...
    when(validationContext37.push(Mockito.<FieldDescriptor>any())).thenReturn(validationContext36);
    ...
    when(validationContext39.apply(Mockito.<Typed<String>>any())).thenReturn(validationContext38);
    ...
    verify(validationContext39).apply(isA(Typed.class));
    verify(validationContext35).apply(isA(Typed.class));
    verify(validationContext31).apply(isA(Typed.class));
    verify(validationContext27).apply(isA(Typed.class));
    ...
    verify(validationContext17).applyMapKeys(isA(Typed.class));
    ...
    verify(validationContext37).push(isA(FieldDescriptor.class));
    verify(validationContext33).push(isA(FieldDescriptor.class));
    verify(validationContext29).push(isA(FieldDescriptor.class));
  ...
  /**
   * Test {@link ModelValidator#modelDetails(FieldDescriptor, FieldDescriptor, FieldDescriptor,
   * FieldDescriptor, FieldDescriptor, ValidationContext)}.
   *
   * <p>Method under test: {@link ModelValidator#modelDetails(FieldDescriptor, FieldDescriptor,
   * FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test modelDetails(FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext ModelValidator.modelDetails(FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)"
  })
  void testModelDetails() {
    // Arrange
    FieldDescriptor languageField = mock(FieldDescriptor.class);
    FieldDescriptor repositoryField = mock(FieldDescriptor.class);
    FieldDescriptor pathField = mock(FieldDescriptor.class);
    FieldDescriptor entryPointField = mock(FieldDescriptor.class);
    FieldDescriptor versionField = mock(FieldDescriptor.class);
    ...
    // Act
    ModelValidator.modelDetails(
        languageField, repositoryField, pathField, entryPointField, versionField, ctx);
  ...
  /**
   * Test {@link ModelValidator#modelSchema(FieldDescriptor, FieldDescriptor, FieldDescriptor,
   * ValidationContext)}.
   *
   * <p>Method under test: {@link ModelValidator#modelSchema(FieldDescriptor, FieldDescriptor,
   * FieldDescriptor, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test modelSchema(FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext ModelValidator.modelSchema(FieldDescriptor, FieldDescriptor, FieldDescriptor, ValidationContext)"
  })
  void testModelSchema() {
    // Arrange
    FieldDescriptor paramsField = mock(FieldDescriptor.class);
    when(paramsField.getName()).thenReturn("Name");

    FieldDescriptor inputsField = mock(FieldDescriptor.class);
    when(inputsField.getName()).thenReturn("Name");

    FieldDescriptor outputsField = mock(FieldDescriptor.class);
    when(outputsField.getName()).thenReturn("Name");
    ...
    ValidationContext ctx = mock(ValidationContext.class);
    when(ctx.pushMap(Mockito.<FieldDescriptor>any())).thenReturn(validationContext20);

    // Act
    ModelValidator.modelSchema(paramsField, inputsField, outputsField, ctx);

    // Assert
    verify(paramsField).getName();
    verify(inputsField).getName();
    verify(outputsField).getName();
    verify(validationContext18).apply(isA(Basic.class));
    verify(validationContext11).apply(isA(Basic.class));
    verify(validationContext4).apply(isA(Basic.class));
    verify(validationContext20).applyMapKeys(isA(Typed.class));
  ...
  /**
   * Test {@link ModelValidator#modelParameter(ModelParameter, ValidationContext)}.
   *
   * <p>Method under test: {@link ModelValidator#modelParameter(ModelParameter, ValidationContext)}
   */
  @Test
  @DisplayName("Test modelParameter(ModelParameter, ValidationContext)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext ModelValidator.modelParameter(ModelParameter, ValidationContext)"
  })
  ...
  /**
   * Test {@link ModelValidator#modelInputSchema(ModelInputSchema, ValidationContext)}.
   *
   * <p>Method under test: {@link ModelValidator#modelInputSchema(ModelInputSchema,
   * ValidationContext)}
   */
  @Test
  @DisplayName("Test modelInputSchema(ModelInputSchema, ValidationContext)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext ModelValidator.modelInputSchema(ModelInputSchema, ValidationContext)"
  })
  void testModelInputSchema() {
    ...
    verify(validationContext10).error("Object type [OBJECT_TYPE_NOT_SET] is not supported");
  ...
  /**
   * Test {@link ModelValidator#modelOutputSchema(ModelOutputSchema, ValidationContext)}.
   *
   * <p>Method under test: {@link ModelValidator#modelOutputSchema(ModelOutputSchema,
   * ValidationContext)}
   */
  @Test
  @DisplayName("Test modelOutputSchema(ModelOutputSchema, ValidationContext)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ValidationContext ModelValidator.modelOutputSchema(ModelOutputSchema, ValidationContext)"
  })
  ...
  /**
   * Test {@link ModelValidator#modelEntryPoint(String, ValidationContext)}.
   *
   * <ul>
   *   <li>When {@code Model Entry Point}.
   *   <li>Then calls {@link ValidationContext#error(String)}.
   * </ul>
   *
   * <p>Method under test: {@link ModelValidator#modelEntryPoint(String, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test modelEntryPoint(String, ValidationContext); when 'Model Entry Point'; then calls error(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ValidationContext ModelValidator.modelEntryPoint(String, ValidationContext)"})
  void testModelEntryPoint_whenModelEntryPoint_thenCallsError() {
    // Arrange
    ValidationContext ctx = mock(ValidationContext.class);
    ...
    verify(ctx)
        .error(
            "Invalid model entry point [Model Entry Point] (expected format: pkg.sub_pkg.ModelClass)");
  }

  /**
   * Test {@link ModelValidator#modelVersion(String, ValidationContext)}.
   *
   * <ul>
   *   <li>Given {@link ValidationContext}.
   *   <li>When {@code Model Version}.
   *   <li>Then calls {@link ValidationContext#error(String)}.
   * </ul>
   *
   * <p>Method under test: {@link ModelValidator#modelVersion(String, ValidationContext)}
   */
  @Test
  @DisplayName(
      "Test modelVersion(String, ValidationContext); given ValidationContext; when 'Model Version'; then calls error(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ValidationContext ModelValidator.modelVersion(String, ValidationContext)"})
  void testModelVersion_givenValidationContext_whenModelVersion_thenCallsError() {
    // Arrange
    ValidationContext ctx = mock(ValidationContext.class);
    when(ctx.error(Mockito.<String>any())).thenReturn(mock(ValidationContext.class));
