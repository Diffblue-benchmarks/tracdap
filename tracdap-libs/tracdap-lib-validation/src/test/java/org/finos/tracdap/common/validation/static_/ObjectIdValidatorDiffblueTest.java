...
class ObjectIdValidatorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#tagHeader(TagHeader, ValidationContext)}
   */
  @Test
  @DisplayName("Test tagHeader(TagHeader, ValidationContext); given ValidationContext failed() return 'true'; then calls apply(Basic)")
   ...
   * <p>
   * Method under test: {@link ObjectIdValidator#tagSelector(TagSelector, ValidationContext)}
   */
  @Test
  @DisplayName("Test tagSelector(TagSelector, ValidationContext)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.tagSelector(TagSelector, ValidationContext)"})
  void testTagSelector() {
    ...
    ValidationContext validationContext4 = mock(ValidationContext.class);
    when(validationContext4.applyOneOf(Mockito.<FieldDescriptor>any(), Mockito.<Typed<Object>>any(),
    ...
    ValidationContext validationContext6 = mock(ValidationContext.class);
    when(validationContext6.pushOneOf(Mockito.<OneofDescriptor>any())).thenReturn(validationContext5);
    ValidationContext validationContext7 = mock(ValidationContext.class);
    when(validationContext7.pop()).thenReturn(validationContext6);
    ValidationContext validationContext8 = mock(ValidationContext.class);
    when(validationContext8.applyOneOf(Mockito.<FieldDescriptor>any(), Mockito.<Typed<Object>>any(),
    ...
    ValidationContext validationContext12 = mock(ValidationContext.class);
    when(validationContext12.pushOneOf(Mockito.<OneofDescriptor>any())).thenReturn(validationContext11);
    ValidationContext validationContext13 = mock(ValidationContext.class);
    ...
    verify(validationContext8).applyOneOf(isA(FieldDescriptor.class), isA(Typed.class), isA(Class.class));
    verify(validationContext4).applyOneOf(isA(FieldDescriptor.class), isA(Typed.class), isA(Class.class));
   ...
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#preallocated(TagSelector, ValidationContext)}
   */
  @Test
  @DisplayName("Test preallocated(TagSelector, ValidationContext); when DefaultInstance; then calls apply(Basic)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.preallocated(TagSelector, ValidationContext)"})
  ...
  /**
   * Test {@link ObjectIdValidator#selectorType(TagSelector, List, ValidationContext)} with {@code selector}, {@code allowedTypes}, {@code ctx}.
   * <ul>
   *   <li>When {@link ArrayList#ArrayList()}.</li>
   *   <li>Then calls {@link ValidationContext#error(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#selectorType(TagSelector, List, ValidationContext)}
   */
  @Test
  @DisplayName("Test selectorType(TagSelector, List, ValidationContext) with 'selector', 'allowedTypes', 'ctx'; when ArrayList(); then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.selectorType(TagSelector, List, ValidationContext)"})
  ...
  /**
   * Test {@link ObjectIdValidator#selectorType(TagSelector, ObjectType, ValidationContext)} with {@code selector}, {@code requiredType}, {@code ctx}.
   * <ul>
   *   <li>Given {@code Field Name}.</li>
   *   <li>Then calls {@link ValidationContext#error(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#selectorType(TagSelector, ObjectType, ValidationContext)}
   */
  @Test
  @DisplayName("Test selectorType(TagSelector, ObjectType, ValidationContext) with 'selector', 'requiredType', 'ctx'; given 'Field Name'; then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.selectorType(TagSelector, ObjectType, ValidationContext)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#selectorForLatest(TagSelector, ValidationContext)}
   */
  @Test
  @DisplayName("Test selectorForLatest(TagSelector, ValidationContext); when DefaultInstance; then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.selectorForLatest(TagSelector, ValidationContext)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#explicitObjectVersion(TagSelector, ValidationContext)}
   */
  @Test
  @DisplayName("Test explicitObjectVersion(TagSelector, ValidationContext); when DefaultInstance; then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.explicitObjectVersion(TagSelector, ValidationContext)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#explicitTagVersion(TagSelector, ValidationContext)}
   */
  @Test
  @DisplayName("Test explicitTagVersion(TagSelector, ValidationContext); when DefaultInstance; then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.explicitTagVersion(TagSelector, ValidationContext)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ObjectIdValidator#versioningSupported(ObjectType, ValidationContext)}
   */
  @Test
  @DisplayName("Test versioningSupported(ObjectType, ValidationContext); when 'OBJECT_TYPE_NOT_SET'; then calls error(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ValidationContext ObjectIdValidator.versioningSupported(ObjectType, ValidationContext)"})
