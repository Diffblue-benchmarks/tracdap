...
class ResultValidatorDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ResultValidator#job(ResultDefinition, ValidationContext)}
   */
  @Test
  ...
  void testJob() {
    ...
    when(validationContext16.apply(Mockito.<TypedArg<Object, Object>>any(), Mockito.<Class<Object>>any(),
        Mockito.<Object>any())).thenReturn(validationContext15);
