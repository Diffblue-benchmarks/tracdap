...
class ObjectVersionValidatorDiffblueTest {
  /**
   * Test {@link ObjectVersionValidator#objectVersion(ObjectDefinition, ObjectDefinition, ValidationContext)}.
   * <p>
   * Method under test: {@link ObjectVersionValidator#objectVersion(ObjectDefinition, ObjectDefinition, ValidationContext)}
   */
  @Test
  ...
  void testObjectVersion() {
    ...
    when(validationContext4.pushOneOf(Mockito.<OneofDescriptor>any())).thenReturn(validationContext3);
