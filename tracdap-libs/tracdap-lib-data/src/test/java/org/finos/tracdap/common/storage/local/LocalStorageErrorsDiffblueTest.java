...
class LocalStorageErrorsDiffblueTest {
   ...
   *   <li>Then return {@code IO_ERROR}.
   * </ul>
   *
   * <p>Method under test: {@link LocalStorageErrors#checkKnownExceptions(Throwable)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "StorageErrors.ExplicitError LocalStorageErrors.checkKnownExceptions(Throwable)"
  })
