...
class CoreDataPluginDiffblueTest {
  ...
  /**
   * Test {@link CoreDataPlugin#createService(String, Properties, ConfigManager)} with {@code serviceName}, {@code properties}, {@code configManager}.
   * <p>
   * Method under test: {@link CoreDataPlugin#createService(String, Properties, ConfigManager)}
   */
  @Test
   ...
   * Test {@link CoreDataPlugin#createService(String, Properties, ConfigManager)} with {@code serviceName}, {@code properties}, {@code configManager}.
   * <ul>
   *   <li>Then return {@link ArrowFileCodec}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CoreDataPlugin#createService(String, Properties, ConfigManager)}
   */
  @Test
  @DisplayName("Test createService(String, Properties, ConfigManager) with 'serviceName', 'properties', 'configManager'; then return ArrowFileCodec")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object CoreDataPlugin.createService(String, Properties, ConfigManager)"})
   ...
   * Test {@link CoreDataPlugin#createService(String, Properties, ConfigManager)} with {@code serviceName}, {@code properties}, {@code configManager}.
   * <ul>
   *   <li>Then return {@link CsvCodec}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CoreDataPlugin#createService(String, Properties, ConfigManager)}
   */
  @Test
  @DisplayName("Test createService(String, Properties, ConfigManager) with 'serviceName', 'properties', 'configManager'; then return CsvCodec")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object CoreDataPlugin.createService(String, Properties, ConfigManager)"})
   ...
   * Test {@link CoreDataPlugin#createService(String, Properties, ConfigManager)} with {@code serviceName}, {@code properties}, {@code configManager}.
   * <ul>
   *   <li>Then return {@link JsonCodec}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CoreDataPlugin#createService(String, Properties, ConfigManager)}
   */
  @Test
  @DisplayName("Test createService(String, Properties, ConfigManager) with 'serviceName', 'properties', 'configManager'; then return JsonCodec")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Object CoreDataPlugin.createService(String, Properties, ConfigManager)"})
