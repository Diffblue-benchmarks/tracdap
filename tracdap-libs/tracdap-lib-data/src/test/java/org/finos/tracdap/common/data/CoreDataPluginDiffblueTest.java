...
class CoreDataPluginDiffblueTest {
  ...
  void testServiceInfo() {
    ...
    Class<ICodec> expectedServiceClassResult2 = ICodec.class;
    assertEquals(expectedServiceClassResult2, getResult.serviceClass());
    Class<ICodec> expectedServiceClassResult3 = ICodec.class;
    assertEquals(expectedServiceClassResult3, getResult3.serviceClass());
    Class<ICodec> expectedServiceClassResult4 = ICodec.class;
    assertEquals(expectedServiceClassResult4, getResult4.serviceClass());
    Class<IFileStorage> expectedServiceClassResult5 = IFileStorage.class;
    assertEquals(expectedServiceClassResult5, getResult5.serviceClass());
  }
