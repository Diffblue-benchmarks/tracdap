...
class ConfigHelpersDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test prepareConfig(List, Path, Map); given '42'; when HashMap() '/' is '42'; then return size is two")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List ConfigHelpers.prepareConfig(List, Path, Map)"})
  void testPrepareConfig_given42_whenHashMapSlashIs42_thenReturnSizeIsTwo() throws Exception {
    // Arrange
