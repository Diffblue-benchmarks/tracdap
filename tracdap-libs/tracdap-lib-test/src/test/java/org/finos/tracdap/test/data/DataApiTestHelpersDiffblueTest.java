...
class DataApiTestHelpersDiffblueTest {
  ...
  void testServerStreamingWithGrpcMethodRequestExecCtx2() {
    ...
    BiConsumer<Object, StreamObserver<Object>> grpcMethod = mock(BiConsumer.class);
    doNothing().when(grpcMethod).accept(Mockito.<Object>any(), Mockito.<StreamObserver<Object>>any());
    DefaultEventExecutor defaultEventExecutor = new DefaultEventExecutor(new DefaultEventLoop(), mock(Executor.class));
   ...
   */
  @Test
  @DisplayName("Test serverStreaming(BiConsumer, Object, IExecutionContext) with 'grpcMethod', 'request', 'execCtx'; given DefaultEventLoop()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CompletionStage DataApiTestHelpers.serverStreaming(BiConsumer, Object, IExecutionContext)"})
   ...
   */
  @Test
  @DisplayName("Test serverStreaming(BiConsumer, Object, IExecutionContext) with 'grpcMethod', 'request', 'execCtx'; then throw EUnexpected")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CompletionStage DataApiTestHelpers.serverStreaming(BiConsumer, Object, IExecutionContext)"})
   ...
   */
  @Test
  @DisplayName("Test serverStreaming(BiConsumer, Object, IExecutionContext) with 'grpcMethod', 'request', 'execCtx'; when ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CompletionStage DataApiTestHelpers.serverStreaming(BiConsumer, Object, IExecutionContext)"})
   ...
   * Test {@link DataApiTestHelpers#serverStreaming(BiConsumer, Object, IExecutionContext)} with {@code grpcMethod}, {@code request}, {@code execCtx}.
   * <ul>
   *   <li>When {@link DefaultEventExecutor#DefaultEventExecutor()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DataApiTestHelpers#serverStreaming(BiConsumer, Object, IExecutionContext)}
   */
  @Test
  @DisplayName("Test serverStreaming(BiConsumer, Object, IExecutionContext) with 'grpcMethod', 'request', 'execCtx'; when DefaultEventExecutor()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CompletionStage DataApiTestHelpers.serverStreaming(BiConsumer, Object, IExecutionContext)"})
   ...
   */
  @Test
  @DisplayName("Test serverStreaming(BiConsumer, Object, IExecutionContext) with 'grpcMethod', 'request', 'execCtx'; when five")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CompletionStage DataApiTestHelpers.serverStreaming(BiConsumer, Object, IExecutionContext)"})
  void testServerStreamingWithGrpcMethodRequestExecCtx_whenFive() {
    ...
    // Act
    CompletionStage<List<Object>> actualServerStreamingResult = DataApiTestHelpers.serverStreaming(grpcMethod, 5,
        execCtx);
   ...
   */
  @Test
  @DisplayName("Test serverStreamingDiscard(BiConsumer, Object, IExecutionContext); given EUnexpected(); then throw EUnexpected")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testServerStreamingDiscard_givenEUnexpected_thenThrowEUnexpected() {
    ...
    // Act and Assert
    assertThrows(EUnexpected.class, () -> DataApiTestHelpers.serverStreamingDiscard(grpcMethod, "Request", execCtx));
    verify(grpcMethod).accept(isA(Object.class), isA(StreamObserver.class));
    verify(execCtx).eventLoopExecutor();
  }
   ...
   */
  @Test
  @DisplayName("Test serverStreamingDiscard(BiConsumer, Object, IExecutionContext); then return CompletableFuture")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "CompletionStage DataApiTestHelpers.serverStreamingDiscard(BiConsumer, Object, IExecutionContext)"})
  void testServerStreamingDiscard_thenReturnCompletableFuture() {
    // Arrange
    BiConsumer<Object, StreamObserver<Object>> grpcMethod = mock(BiConsumer.class);
    doNothing().when(grpcMethod).accept(Mockito.<Object>any(), Mockito.<StreamObserver<Object>>any());
    IExecutionContext execCtx = mock(IExecutionContext.class);
