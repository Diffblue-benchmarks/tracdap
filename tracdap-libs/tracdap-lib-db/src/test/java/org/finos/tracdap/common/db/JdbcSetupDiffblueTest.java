...
class JdbcSetupDiffblueTest {
   ...
   *   <li>Then calls {@link HikariDataSource#setMetricRegistry(Object)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link JdbcSetup#destroyDatasource(DataSource)}
   */
  @Test
  @DisplayName("Test destroyDatasource(DataSource); given 'null'; then calls setMetricRegistry(Object)")
  @Tag("MaintainedByDiffblue")
